...
cat(int fd)
{
  ...
  14:	9a090913          	addi	s2,s2,-1632 # 9b0 <buf>
  ...
  44:	90058593          	addi	a1,a1,-1792 # 940 <lock_release+0x1e>
  48:	4509                	li	a0,2
  ...
  72:	8ea58593          	addi	a1,a1,-1814 # 958 <lock_release+0x36>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	86e58593          	addi	a1,a1,-1938 # 970 <lock_release+0x4e>
 10a:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 550:	444b8b93          	addi	s7,s7,1092 # 990 <digits>
 ...
 690:	2fc90913          	addi	s2,s2,764 # 988 <lock_release+0x66>
        while(*s != 0){
...
free(void *ap)
{
 ...
 758:	2547b783          	ld	a5,596(a5) # 9a8 <freep>
 ...
 786:	00e6ea63          	bltu	a3,a4,79a <free+0x50>
{
 ...
 7c8:	1ef73223          	sd	a5,484(a4) # 9a8 <freep>
}
 7cc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fa:	1b253503          	ld	a0,434(a0) # 9a8 <freep>
 ...
 822:	18a90913          	addi	s2,s2,394 # 9a8 <freep>
  if(p == (char*)-1)
 826:	5afd                	li	s5,-1
 828:	a88d                	j	89a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 82a:	00000797          	auipc	a5,0x0
 82e:	38678793          	addi	a5,a5,902 # bb0 <base>
 832:	00000717          	auipc	a4,0x0
 836:	16f73b23          	sd	a5,374(a4) # 9a8 <freep>
 83a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 85c:	14a73823          	sd	a0,336(a4) # 9a8 <freep>
      return (void*)(p + 1);
...
00000000000008b6 <thread_create>:
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 8cc:	f0a080e7          	jalr	-246(ra) # 7d2 <malloc>
	threadid  = clone(stack);
 8d0:	00000097          	auipc	ra,0x0
 8d4:	b64080e7          	jalr	-1180(ra) # 434 <clone>
	if(threadid != 0) {
 8d8:	c901                	beqz	a0,8e8 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 8f2:	aa6080e7          	jalr	-1370(ra) # 394 <exit>

00000000000008f6 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 8fa:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 8fc:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x440>
}
 900:	6422                	ld	s0,8(sp)
 902:	0141                	addi	sp,sp,16
 904:	8082                	ret

0000000000000906 <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 90c:	4705                	li	a4,1
 90e:	87ba                	mv	a5,a4
 910:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 914:	2781                	sext.w	a5,a5
 916:	ffe5                	bnez	a5,90e <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 92c:	0f50000f          	fence	iorw,ow
 930:	0805202f          	amoswap.w	zero,zero,(a0)
 934:	6422                	ld	s0,8(sp)
