...
wc(int fd, char *name)
{
  ...
  3c:	980a0a13          	addi	s4,s4,-1664 # 9b8 <lock_release+0x1e>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	91a50513          	addi	a0,a0,-1766 # 9d0 <lock_release+0x36>
  ...
  e8:	8dc50513          	addi	a0,a0,-1828 # 9c0 <lock_release+0x26>
...
main(int argc, char *argv[])
{
 ...
 162:	88258593          	addi	a1,a1,-1918 # 9e0 <lock_release+0x46>
 166:	4501                	li	a0,0
 ...
 180:	86c50513          	addi	a0,a0,-1940 # 9e8 <lock_release+0x4e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fc:	51050513          	addi	a0,a0,1296 # a08 <digits>
 500:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c8:	444b8b93          	addi	s7,s7,1092 # a08 <digits>
 ...
 708:	2fc90913          	addi	s2,s2,764 # a00 <lock_release+0x66>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7d0:	2547b783          	ld	a5,596(a5) # a20 <freep>
 ...
 7fe:	00e6ea63          	bltu	a3,a4,812 <free+0x50>
{
 ...
 840:	1ef73223          	sd	a5,484(a4) # a20 <freep>
}
 844:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 872:	1b253503          	ld	a0,434(a0) # a20 <freep>
 ...
 89a:	18a90913          	addi	s2,s2,394 # a20 <freep>
  if(p == (char*)-1)
 89e:	5afd                	li	s5,-1
 8a0:	a88d                	j	912 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 8a2:	00000797          	auipc	a5,0x0
 8a6:	38678793          	addi	a5,a5,902 # c28 <base>
 8aa:	00000717          	auipc	a4,0x0
 8ae:	16f73b23          	sd	a5,374(a4) # a20 <freep>
 8b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8d4:	14a73823          	sd	a0,336(a4) # a20 <freep>
      return (void*)(p + 1);
...
000000000000092e <thread_create>:
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 944:	f0a080e7          	jalr	-246(ra) # 84a <malloc>
	threadid  = clone(stack);
 948:	00000097          	auipc	ra,0x0
 94c:	b64080e7          	jalr	-1180(ra) # 4ac <clone>
	if(threadid != 0) {
 950:	c901                	beqz	a0,960 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 96a:	aa6080e7          	jalr	-1370(ra) # 40c <exit>

000000000000096e <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 972:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 974:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x3c8>
}
 978:	6422                	ld	s0,8(sp)
 97a:	0141                	addi	sp,sp,16
 97c:	8082                	ret

000000000000097e <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 984:	4705                	li	a4,1
 986:	87ba                	mv	a5,a4
 988:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 98c:	2781                	sext.w	a5,a5
 98e:	ffe5                	bnez	a5,986 <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 9a4:	0f50000f          	fence	iorw,ow
 9a8:	0805202f          	amoswap.w	zero,zero,(a0)
 9ac:	6422                	ld	s0,8(sp)
