...
000000000000011a <grep>:
{
 ...
 144:	9f0b0b13          	addi	s6,s6,-1552 # b30 <buf>
    p = buf;
 148:	8d5a                	mv	s10,s6
        *q = '\n';
 14a:	4aa9                	li	s5,10
...
00000000000001ee <main>:
{
 ...
 262:	87258593          	addi	a1,a1,-1934 # ad0 <lock_release+0x1e>
 266:	4509                	li	a0,2
 ...
 298:	85c50513          	addi	a0,a0,-1956 # af0 <lock_release+0x3e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 614:	50050513          	addi	a0,a0,1280 # b10 <digits>
 618:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e0:	434b8b93          	addi	s7,s7,1076 # b10 <digits>
 ...
 820:	2ec90913          	addi	s2,s2,748 # b08 <lock_release+0x56>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e8:	2447b783          	ld	a5,580(a5) # b28 <freep>
 ...
 916:	00e6ea63          	bltu	a3,a4,92a <free+0x50>
{
 ...
 958:	1cf73a23          	sd	a5,468(a4) # b28 <freep>
}
 95c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 98a:	1a253503          	ld	a0,418(a0) # b28 <freep>
 ...
 9b2:	17a90913          	addi	s2,s2,378 # b28 <freep>
  if(p == (char*)-1)
 9b6:	5afd                	li	s5,-1
 9b8:	a88d                	j	a2a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9ba:	00000797          	auipc	a5,0x0
 9be:	57678793          	addi	a5,a5,1398 # f30 <base>
 9c2:	00000717          	auipc	a4,0x0
 9c6:	16f73323          	sd	a5,358(a4) # b28 <freep>
 9ca:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9ec:	14a73023          	sd	a0,320(a4) # b28 <freep>
      return (void*)(p + 1);
...
0000000000000a46 <thread_create>:
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 a5c:	f0a080e7          	jalr	-246(ra) # 962 <malloc>
	threadid  = clone(stack);
 a60:	00000097          	auipc	ra,0x0
 a64:	b64080e7          	jalr	-1180(ra) # 5c4 <clone>
	if(threadid != 0) {
 a68:	c901                	beqz	a0,a78 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
...
void lock_init(lock_t *lock)
{
 ...
 a8a:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 a8c:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0xc0>
}
 a90:	6422                	ld	s0,8(sp)
