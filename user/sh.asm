...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	36058593          	addi	a1,a1,864 # 1370 <lock_release+0x18>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	31a58593          	addi	a1,a1,794 # 1378 <lock_release+0x20>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2e850513          	addi	a0,a0,744 # 1380 <lock_release+0x28>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3bc70713          	addi	a4,a4,956 # 1480 <lock_release+0x128>
    ...
    panic("runcmd");
      ...
      e2:	2aa50513          	addi	a0,a0,682 # 1388 <lock_release+0x30>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	29058593          	addi	a1,a1,656 # 1390 <lock_release+0x38>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	25458593          	addi	a1,a1,596 # 13a0 <lock_release+0x48>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1ce50513          	addi	a0,a0,462 # 13b0 <lock_release+0x58>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	07a98993          	addi	s3,s3,122 # 14d8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	01098993          	addi	s3,s3,16 # 14d8 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	000a8a93          	mv	s5,s5
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	fa698993          	addi	s3,s3,-90 # 14d8 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e36b8b93          	addi	s7,s7,-458 # 13d8 <lock_release+0x80>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e0450513          	addi	a0,a0,-508 # 13b8 <lock_release+0x60>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d4460613          	addi	a2,a2,-700 # 13e0 <lock_release+0x88>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d34b0b13          	addi	s6,s6,-716 # 1400 <lock_release+0xa8>
  ...
  return ret;
     ...
     70a:	ce250513          	addi	a0,a0,-798 # 13e8 <lock_release+0x90>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c8850513          	addi	a0,a0,-888 # 13f0 <lock_release+0x98>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c6660613          	addi	a2,a2,-922 # 1408 <lock_release+0xb0>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bfea0a13          	addi	s4,s4,-1026 # 1410 <lock_release+0xb8>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bd060613          	addi	a2,a2,-1072 # 1418 <lock_release+0xc0>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b3260613          	addi	a2,a2,-1230 # 13e0 <lock_release+0x88>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b5260613          	addi	a2,a2,-1198 # 1430 <lock_release+0xd8>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	b0050513          	addi	a0,a0,-1280 # 1420 <lock_release+0xc8>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b0850513          	addi	a0,a0,-1272 # 1438 <lock_release+0xe0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b3c70713          	addi	a4,a4,-1220 # 1498 <lock_release+0x140>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a4860613          	addi	a2,a2,-1464 # 1450 <lock_release+0xf8>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a1a58593          	addi	a1,a1,-1510 # 1458 <lock_release+0x100>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6d4080e7          	jalr	1748(ra) # 111c <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	99850513          	addi	a0,a0,-1640 # 13e8 <lock_release+0x90>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9f648493          	addi	s1,s1,-1546 # 1468 <lock_release+0x110>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a5048493          	addi	s1,s1,-1456 # 14e8 <buf.1135>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a43a0a13          	addi	s4,s4,-1469 # 14eb <buf.1135+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9c0a8a93          	addi	s5,s5,-1600 # 1470 <lock_release+0x118>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	9b650513          	addi	a0,a0,-1610 # 14e8 <buf.1135>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eba:	60250513          	addi	a0,a0,1538 # 14b8 <digits>
     ebe:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f86:	536b8b93          	addi	s7,s7,1334 # 14b8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c6:	3ee90913          	addi	s2,s2,1006 # 14b0 <lock_release+0x158>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    118e:	3567b783          	ld	a5,854(a5) # 14e0 <freep>
    ...
    11bc:	00e6ea63          	bltu	a3,a4,11d0 <free+0x50>
{
  ...
  freep = p;
    ...
    11fe:	2ef73323          	sd	a5,742(a4) # 14e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1230:	2b453503          	ld	a0,692(a0) # 14e0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1258:	28c90913          	addi	s2,s2,652 # 14e0 <freep>
  if(p == (char*)-1)
    125c:	5afd                	li	s5,-1
    125e:	a88d                	j	12d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1260:	00000797          	auipc	a5,0x0
    1264:	2f078793          	addi	a5,a5,752 # 1550 <base>
    1268:	00000717          	auipc	a4,0x0
    126c:	26f73c23          	sd	a5,632(a4) # 14e0 <freep>
    ...
    1292:	24a73923          	sd	a0,594(a4) # 14e0 <freep>
      return (void*)(p + 1);
...
00000000000012ec <thread_create>:
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
    ...
    12f2:	e426                	sd	s1,8(sp)
    12f4:	e04a                	sd	s2,0(sp)
    12f6:	1000                	addi	s0,sp,32
    12f8:	84aa                	mv	s1,a0
    12fa:	892e                	mv	s2,a1
	int threadid;
	void* stack = (void*)malloc(4096 * sizeof(void));
    12fc:	6505                	lui	a0,0x1
    12fe:	00000097          	auipc	ra,0x0
    1302:	f0a080e7          	jalr	-246(ra) # 1208 <malloc>
	threadid  = clone(stack);
    1306:	00000097          	auipc	ra,0x0
    130a:	b64080e7          	jalr	-1180(ra) # e6a <clone>
	if(threadid != 0) {
    130e:	c901                	beqz	a0,131e <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
    ...
    1328:	aa6080e7          	jalr	-1370(ra) # dca <exit>

000000000000132c <lock_init>:

//Lock implementation
void lock_init(lock_t *lock)
{
    132c:	1141                	addi	sp,sp,-16
    132e:	e422                	sd	s0,8(sp)
    1330:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
    1332:	00052023          	sw	zero,0(a0) # 1000 <vprintf+0xc2>
}
    1336:	6422                	ld	s0,8(sp)
    1338:	0141                	addi	sp,sp,16
    133a:	8082                	ret

000000000000133c <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
    ...
    1342:	4705                	li	a4,1
    1344:	87ba                	mv	a5,a4
    1346:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    134a:	2781                	sext.w	a5,a5
    134c:	ffe5                	bnez	a5,1344 <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
  ...
  //   amoswap.w zero, zero, (s1)
    ...
    1362:	0f50000f          	fence	iorw,ow
    1366:	0805202f          	amoswap.w	zero,zero,(a0)
