...
fmtname(char *path)
{
  ...
  6a:	b2298993          	addi	s3,s3,-1246 # b88 <buf.1109>
...
ls(char *path)
{
 ...
 128:	9fc50513          	addi	a0,a0,-1540 # b20 <lock_release+0x48>
 ...
 166:	98e58593          	addi	a1,a1,-1650 # af0 <lock_release+0x18>
 16a:	4509                	li	a0,2
 ...
 17c:	99058593          	addi	a1,a1,-1648 # b08 <lock_release+0x30>
 180:	4509                	li	a0,2
 ...
 1ae:	98650513          	addi	a0,a0,-1658 # b30 <lock_release+0x58>
 ...
 1f4:	958a0a13          	addi	s4,s4,-1704 # b48 <lock_release+0x70>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	910a8a93          	addi	s5,s5,-1776 # b08 <lock_release+0x30>
...
main(int argc, char *argv[])
{
 ...
 2be:	89e50513          	addi	a0,a0,-1890 # b58 <lock_release+0x80>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 63a:	53250513          	addi	a0,a0,1330 # b68 <digits>
 63e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 706:	466b8b93          	addi	s7,s7,1126 # b68 <digits>
 ...
 846:	31e90913          	addi	s2,s2,798 # b60 <lock_release+0x88>
        while(*s != 0){
...
free(void *ap)
{
 ...
 90e:	2767b783          	ld	a5,630(a5) # b80 <freep>
 ...
 93c:	00e6ea63          	bltu	a3,a4,950 <free+0x50>
{
 ...
 97e:	20f73323          	sd	a5,518(a4) # b80 <freep>
}
 982:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9b0:	1d453503          	ld	a0,468(a0) # b80 <freep>
 ...
 9d8:	1ac90913          	addi	s2,s2,428 # b80 <freep>
  if(p == (char*)-1)
 9dc:	5afd                	li	s5,-1
 9de:	a88d                	j	a50 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9e0:	00000797          	auipc	a5,0x0
 9e4:	1b878793          	addi	a5,a5,440 # b98 <base>
 9e8:	00000717          	auipc	a4,0x0
 9ec:	18f73c23          	sd	a5,408(a4) # b80 <freep>
 9f0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a12:	16a73923          	sd	a0,370(a4) # b80 <freep>
      return (void*)(p + 1);
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 a82:	f0a080e7          	jalr	-246(ra) # 988 <malloc>
	threadid  = clone(stack);
 a86:	00000097          	auipc	ra,0x0
 a8a:	b64080e7          	jalr	-1180(ra) # 5ea <clone>
	if(threadid != 0) {
 ...
 aa8:	aa6080e7          	jalr	-1370(ra) # 54a <exit>
...
void lock_init(lock_t *lock)
{
 ...
 ab0:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 ab2:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x458>
}
 ab6:	6422                	ld	s0,8(sp)
