...
main(int argc, char *argv[])
{
  ...
  2e:	876a0a13          	addi	s4,s4,-1930 # 8a0 <lock_release+0x18>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	84058593          	addi	a1,a1,-1984 # 8a8 <lock_release+0x20>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b6:	406b8b93          	addi	s7,s7,1030 # 8b8 <digits>
 ...
 5f6:	2be90913          	addi	s2,s2,702 # 8b0 <lock_release+0x28>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6be:	2167b783          	ld	a5,534(a5) # 8d0 <freep>
 ...
 6ec:	00e6ea63          	bltu	a3,a4,700 <free+0x50>
{
 ...
 72e:	1af73323          	sd	a5,422(a4) # 8d0 <freep>
}
 732:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 760:	17453503          	ld	a0,372(a0) # 8d0 <freep>
 ...
 788:	14c90913          	addi	s2,s2,332 # 8d0 <freep>
  if(p == (char*)-1)
 78c:	5afd                	li	s5,-1
 78e:	a88d                	j	800 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 790:	00000797          	auipc	a5,0x0
 794:	14878793          	addi	a5,a5,328 # 8d8 <base>
...
000000000000081c <thread_create>:
#include "kernel/stat.h"
#include "user/user.h"
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 832:	f0a080e7          	jalr	-246(ra) # 738 <malloc>
	threadid  = clone(stack);
 836:	00000097          	auipc	ra,0x0
 83a:	b64080e7          	jalr	-1180(ra) # 39a <clone>
	if(threadid != 0) {
 83e:	c901                	beqz	a0,84e <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 858:	aa6080e7          	jalr	-1370(ra) # 2fa <exit>

000000000000085c <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 860:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 862:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x718>
}
 866:	6422                	ld	s0,8(sp)
 868:	0141                	addi	sp,sp,16
 86a:	8082                	ret

000000000000086c <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 872:	4705                	li	a4,1
 874:	87ba                	mv	a5,a4
 876:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 87a:	2781                	sext.w	a5,a5
 87c:	ffe5                	bnez	a5,874 <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 892:	0f50000f          	fence	iorw,ow
 896:	0805202f          	amoswap.w	zero,zero,(a0)
 89a:	6422                	ld	s0,8(sp)
