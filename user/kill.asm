...
main(int argc, char **argv)
{
  ...
  4c:	83858593          	addi	a1,a1,-1992 # 880 <lock_release+0x18>
  50:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d6:	2c690913          	addi	s2,s2,710 # 898 <lock_release+0x30>
        while(*s != 0){
 ...
 6cc:	00e6ea63          	bltu	a3,a4,6e0 <free+0x50>
{
 ...
 70e:	1af73723          	sd	a5,430(a4) # 8b8 <freep>
}
 712:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 740:	17c53503          	ld	a0,380(a0) # 8b8 <freep>
 ...
 768:	15490913          	addi	s2,s2,340 # 8b8 <freep>
  if(p == (char*)-1)
 76c:	5afd                	li	s5,-1
 76e:	a88d                	j	7e0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 770:	00000797          	auipc	a5,0x0
 774:	15078793          	addi	a5,a5,336 # 8c0 <base>
 778:	00000717          	auipc	a4,0x0
 77c:	14f73023          	sd	a5,320(a4) # 8b8 <freep>
 780:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a2:	10a73d23          	sd	a0,282(a4) # 8b8 <freep>
      return (void*)(p + 1);
...
00000000000007fc <thread_create>:
#include "kernel/stat.h"
#include "user/user.h"
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 812:	f0a080e7          	jalr	-246(ra) # 718 <malloc>
	threadid  = clone(stack);
 816:	00000097          	auipc	ra,0x0
 81a:	b64080e7          	jalr	-1180(ra) # 37a <clone>
	if(threadid != 0) {
 81e:	c901                	beqz	a0,82e <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 838:	aa6080e7          	jalr	-1370(ra) # 2da <exit>

000000000000083c <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 840:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 842:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x730>
}
 846:	6422                	ld	s0,8(sp)
 848:	0141                	addi	sp,sp,16
 84a:	8082                	ret

000000000000084c <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 852:	4705                	li	a4,1
 854:	87ba                	mv	a5,a4
 856:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 85a:	2781                	sext.w	a5,a5
 85c:	ffe5                	bnez	a5,854 <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 872:	0f50000f          	fence	iorw,ow
 876:	0805202f          	amoswap.w	zero,zero,(a0)
 87a:	6422                	ld	s0,8(sp)
