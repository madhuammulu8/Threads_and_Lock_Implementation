...
main(int argc, char *argv[])
{
  ...
  42:	85a58593          	addi	a1,a1,-1958 # 898 <lock_release+0x1c>
  46:	4509                	li	a0,2
  ...
  60:	85458593          	addi	a1,a1,-1964 # 8b0 <lock_release+0x34>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	4fe50513          	addi	a0,a0,1278 # 8d8 <digits>
 3e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4aa:	432b8b93          	addi	s7,s7,1074 # 8d8 <digits>
 ...
 5ea:	2ea90913          	addi	s2,s2,746 # 8d0 <lock_release+0x54>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b2:	2427b783          	ld	a5,578(a5) # 8f0 <freep>
 ...
 6e0:	00e6ea63          	bltu	a3,a4,6f4 <free+0x50>
{
 ...
 722:	1cf73923          	sd	a5,466(a4) # 8f0 <freep>
}
 726:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 754:	1a053503          	ld	a0,416(a0) # 8f0 <freep>
 ...
 77c:	17890913          	addi	s2,s2,376 # 8f0 <freep>
  if(p == (char*)-1)
 780:	5afd                	li	s5,-1
 782:	a88d                	j	7f4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 784:	00000797          	auipc	a5,0x0
 788:	17478793          	addi	a5,a5,372 # 8f8 <base>
 78c:	00000717          	auipc	a4,0x0
 790:	16f73223          	sd	a5,356(a4) # 8f0 <freep>
 794:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b6:	12a73f23          	sd	a0,318(a4) # 8f0 <freep>
      return (void*)(p + 1);
...
0000000000000810 <thread_create>:
#include "kernel/stat.h"
#include "user/user.h"
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 826:	f0a080e7          	jalr	-246(ra) # 72c <malloc>
	threadid  = clone(stack);
 82a:	00000097          	auipc	ra,0x0
 82e:	b64080e7          	jalr	-1180(ra) # 38e <clone>
	if(threadid != 0) {
 832:	c901                	beqz	a0,842 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 84c:	aa6080e7          	jalr	-1370(ra) # 2ee <exit>

0000000000000850 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 854:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 856:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x6f8>
}
 85a:	6422                	ld	s0,8(sp)
 85c:	0141                	addi	sp,sp,16
 85e:	8082                	ret

0000000000000860 <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 866:	4705                	li	a4,1
 868:	87ba                	mv	a5,a4
 86a:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 86e:	2781                	sext.w	a5,a5
 870:	ffe5                	bnez	a5,868 <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 886:	0f50000f          	fence	iorw,ow
 88a:	0805202f          	amoswap.w	zero,zero,(a0)
 88e:	6422                	ld	s0,8(sp)
