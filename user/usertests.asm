...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	11a50513          	addi	a0,a0,282 # 6158 <lock_release+0x378>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	6b078793          	addi	a5,a5,1712 # 9708 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	db868693          	addi	a3,a3,-584 # be18 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	0f850513          	addi	a0,a0,248 # 6178 <lock_release+0x398>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0e850513          	addi	a0,a0,232 # 6190 <lock_release+0x3b0>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0ea50513          	addi	a0,a0,234 # 61b0 <lock_release+0x3d0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0b250513          	addi	a0,a0,178 # 6198 <lock_release+0x3b8>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0be50513          	addi	a0,a0,190 # 61c0 <lock_release+0x3e0>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0bc50513          	addi	a0,a0,188 # 61e8 <lock_release+0x408>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0a850513          	addi	a0,a0,168 # 61e8 <lock_release+0x408>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0a458593          	addi	a1,a1,164 # 61f8 <lock_release+0x418>
     15c:	00005097          	auipc	ra,0x5
     160:	716080e7          	jalr	1814(ra) # 5872 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	08050513          	addi	a0,a0,128 # 61e8 <lock_release+0x408>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	08458593          	addi	a1,a1,132 # 6200 <lock_release+0x420>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	05450513          	addi	a0,a0,84 # 61e8 <lock_release+0x408>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	03e50513          	addi	a0,a0,62 # 6208 <lock_release+0x428>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	d5c50513          	addi	a0,a0,-676 # 5fd8 <lock_release+0x1f8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	d48a8a93          	addi	s5,s5,-696 # 5fd8 <lock_release+0x1f8>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b80a0a13          	addi	s4,s4,-1152 # be18 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f1e50513          	addi	a0,a0,-226 # 6230 <lock_release+0x450>
     ...
     33a:	f1a50513          	addi	a0,a0,-230 # 6250 <lock_release+0x470>
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	ef6a0a13          	addi	s4,s4,-266 # 6268 <lock_release+0x488>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	e5250513          	addi	a0,a0,-430 # 6270 <lock_release+0x490>
     ...
     440:	e4c50513          	addi	a0,a0,-436 # 6288 <lock_release+0x4a8>
     ...
     45e:	e5e50513          	addi	a0,a0,-418 # 62b8 <lock_release+0x4d8>
     ...
     478:	e7450513          	addi	a0,a0,-396 # 62e8 <lock_release+0x508>
     ...
     496:	e6650513          	addi	a0,a0,-410 # 62f8 <lock_release+0x518>
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	e58a0a13          	addi	s4,s4,-424 # 6328 <lock_release+0x548>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	d28a8a93          	addi	s5,s5,-728 # 6200 <lock_release+0x420>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	db250513          	addi	a0,a0,-590 # 6330 <lock_release+0x550>
     ...
     5a0:	dac50513          	addi	a0,a0,-596 # 6348 <lock_release+0x568>
     ...
     5ba:	d3250513          	addi	a0,a0,-718 # 62e8 <lock_release+0x508>
     ...
     5d4:	da850513          	addi	a0,a0,-600 # 6378 <lock_release+0x598>
     ...
     5f2:	da250513          	addi	a0,a0,-606 # 6390 <lock_release+0x5b0>
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	bb458593          	addi	a1,a1,-1100 # 61f8 <lock_release+0x418>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b8850513          	addi	a0,a0,-1144 # 61e8 <lock_release+0x408>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	b5c50513          	addi	a0,a0,-1188 # 61e8 <lock_release+0x408>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	b4850513          	addi	a0,a0,-1208 # 61e8 <lock_release+0x408>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	d4258593          	addi	a1,a1,-702 # 6420 <lock_release+0x640>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	ac850513          	addi	a0,a0,-1336 # 61e8 <lock_release+0x408>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	c5c50513          	addi	a0,a0,-932 # 63c0 <lock_release+0x5e0>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	c6050513          	addi	a0,a0,-928 # 63e0 <lock_release+0x600>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     798:	c5c50513          	addi	a0,a0,-932 # 63f0 <lock_release+0x610>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	c6050513          	addi	a0,a0,-928 # 6410 <lock_release+0x630>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c8:	c2c50513          	addi	a0,a0,-980 # 63f0 <lock_release+0x610>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	c4650513          	addi	a0,a0,-954 # 6428 <lock_release+0x648>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	c4850513          	addi	a0,a0,-952 # 6448 <lock_release+0x668>
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	c3450513          	addi	a0,a0,-972 # 6468 <lock_release+0x688>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	c4498993          	addi	s3,s3,-956 # 6490 <lock_release+0x6b0>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c74a8a93          	addi	s5,s5,-908 # 64c8 <lock_release+0x6e8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	bce50513          	addi	a0,a0,-1074 # 6468 <lock_release+0x688>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	56458593          	addi	a1,a1,1380 # be18 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b9250513          	addi	a0,a0,-1134 # 6468 <lock_release+0x688>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b7050513          	addi	a0,a0,-1168 # 6470 <lock_release+0x690>
    ...
    exit(1);
     ...
     922:	b8250513          	addi	a0,a0,-1150 # 64a0 <lock_release+0x6c0>
     ...
     940:	b9c50513          	addi	a0,a0,-1124 # 64d8 <lock_release+0x6f8>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	ba850513          	addi	a0,a0,-1112 # 6500 <lock_release+0x720>
    ...
    printf("%s: read failed\n", s);
     ...
     978:	bac50513          	addi	a0,a0,-1108 # 6520 <lock_release+0x740>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	ba850513          	addi	a0,a0,-1112 # 6538 <lock_release+0x758>
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b9650513          	addi	a0,a0,-1130 # 6558 <lock_release+0x778>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	44290913          	addi	s2,s2,1090 # be18 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	b4450513          	addi	a0,a0,-1212 # 6558 <lock_release+0x778>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	3f090913          	addi	s2,s2,1008 # be18 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	b0450513          	addi	a0,a0,-1276 # 6560 <lock_release+0x780>
    ...
    exit(1);
     ...
     a7e:	b0650513          	addi	a0,a0,-1274 # 6580 <lock_release+0x7a0>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	b1250513          	addi	a0,a0,-1262 # 65a8 <lock_release+0x7c8>
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a9650513          	addi	a0,a0,-1386 # 6558 <lock_release+0x778>
     ...
     af2:	ada50513          	addi	a0,a0,-1318 # 65c8 <lock_release+0x7e8>
     ...
     b10:	ae450513          	addi	a0,a0,-1308 # 65f0 <lock_release+0x810>
     ...
     b2e:	ade50513          	addi	a0,a0,-1314 # 6608 <lock_release+0x828>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	aea50513          	addi	a0,a0,-1302 # 6630 <lock_release+0x850>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	3f450513          	addi	a0,a0,1012 # 5f68 <lock_release+0x188>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	adc58593          	addi	a1,a1,-1316 # 6668 <lock_release+0x888>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	3c050513          	addi	a0,a0,960 # 5f68 <lock_release+0x188>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	3aa50513          	addi	a0,a0,938 # 5f68 <lock_release+0x188>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	39450513          	addi	a0,a0,916 # 5f68 <lock_release+0x188>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	ac858593          	addi	a1,a1,-1336 # 66b0 <lock_release+0x8d0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	21458593          	addi	a1,a1,532 # be18 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	31850513          	addi	a0,a0,792 # 5f68 <lock_release+0x188>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	9d850513          	addi	a0,a0,-1576 # 6648 <lock_release+0x868>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	9e450513          	addi	a0,a0,-1564 # 6670 <lock_release+0x890>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	9e850513          	addi	a0,a0,-1560 # 6690 <lock_release+0x8b0>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	9f450513          	addi	a0,a0,-1548 # 66b8 <lock_release+0x8d8>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	9f850513          	addi	a0,a0,-1544 # 66d8 <lock_release+0x8f8>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	9fc50513          	addi	a0,a0,-1540 # 66f8 <lock_release+0x918>
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	90858593          	addi	a1,a1,-1784 # 6668 <lock_release+0x888>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	9a058593          	addi	a1,a1,-1632 # 6720 <lock_release+0x940>
     d88:	00006517          	auipc	a0,0x6
     d8c:	99050513          	addi	a0,a0,-1648 # 6718 <lock_release+0x938>
  ...
  unlink("lf1");
     ...
     da0:	97c50513          	addi	a0,a0,-1668 # 6718 <lock_release+0x938>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	96a50513          	addi	a0,a0,-1686 # 6718 <lock_release+0x938>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	95c50513          	addi	a0,a0,-1700 # 6720 <lock_release+0x940>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	03c58593          	addi	a1,a1,60 # be18 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	92458593          	addi	a1,a1,-1756 # 6720 <lock_release+0x940>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	90e50513          	addi	a0,a0,-1778 # 6720 <lock_release+0x940>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	8f658593          	addi	a1,a1,-1802 # 6718 <lock_release+0x938>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	8f650513          	addi	a0,a0,-1802 # 6720 <lock_release+0x940>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	8da58593          	addi	a1,a1,-1830 # 6718 <lock_release+0x938>
     e46:	00006517          	auipc	a0,0x6
     e4a:	9e250513          	addi	a0,a0,-1566 # 6828 <lock_release+0xa48>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	8c050513          	addi	a0,a0,-1856 # 6728 <lock_release+0x948>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	8bc50513          	addi	a0,a0,-1860 # 6740 <lock_release+0x960>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	8b850513          	addi	a0,a0,-1864 # 6758 <lock_release+0x978>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	8bc50513          	addi	a0,a0,-1860 # 6778 <lock_release+0x998>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	8d050513          	addi	a0,a0,-1840 # 67a8 <lock_release+0x9c8>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	8cc50513          	addi	a0,a0,-1844 # 67c0 <lock_release+0x9e0>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	8c850513          	addi	a0,a0,-1848 # 67d8 <lock_release+0x9f8>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	8d450513          	addi	a0,a0,-1836 # 6800 <lock_release+0xa20>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	8e850513          	addi	a0,a0,-1816 # 6830 <lock_release+0xa50>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	8a2a0a13          	addi	s4,s4,-1886 # 6850 <lock_release+0xa70>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	85050513          	addi	a0,a0,-1968 # 6850 <lock_release+0xa70>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	7e850513          	addi	a0,a0,2024 # 6858 <lock_release+0xa78>
    ...
    1094:	7e850513          	addi	a0,a0,2024 # 6878 <lock_release+0xa98>
    ...
    10b0:	7ec50513          	addi	a0,a0,2028 # 6898 <lock_release+0xab8>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	7da98993          	addi	s3,s3,2010 # 68b8 <lock_release+0xad8>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	7ae50513          	addi	a0,a0,1966 # 68c8 <lock_release+0xae8>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	4ae4b483          	ld	s1,1198(s1) # 85f0 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x538>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	00a98993          	addi	s3,s3,10 # 6190 <lock_release+0x3b0>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	8a078793          	addi	a5,a5,-1888 # 7ab0 <lock_release+0x1cd0>
  ...
  if(pid == 0){
    ...
    124a:	4ba78793          	addi	a5,a5,1210 # 8700 <big.1272>
    124e:	00008697          	auipc	a3,0x8
    1252:	4b268693          	addi	a3,a3,1202 # 9700 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	48078e23          	sb	zero,1180(a5) # 9700 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	f5478793          	addi	a5,a5,-172 # 81c0 <lock_release+0x23e0>
    ...
    1294:	f0050513          	addi	a0,a0,-256 # 6190 <lock_release+0x3b0>
    ...
    12ac:	6c850513          	addi	a0,a0,1736 # 6970 <lock_release+0xb90>
    ...
    12cc:	62050513          	addi	a0,a0,1568 # 68e8 <lock_release+0xb08>
    ...
    12ec:	62050513          	addi	a0,a0,1568 # 6908 <lock_release+0xb28>
    ...
    130e:	61e50513          	addi	a0,a0,1566 # 6928 <lock_release+0xb48>
    ...
    132e:	62650513          	addi	a0,a0,1574 # 6950 <lock_release+0xb70>
    ...
    1348:	aa450513          	addi	a0,a0,-1372 # 6de8 <lock_release+0x1008>
  ...
  if(st != 747){
    ...
    1392:	60a50513          	addi	a0,a0,1546 # 6998 <lock_release+0xbb8>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	e2850513          	addi	a0,a0,-472 # 61e8 <lock_release+0x408>
  ...
  if(pid == 0){
    ...
    13ee:	dfea0a13          	addi	s4,s4,-514 # 61e8 <lock_release+0x408>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	606a8a93          	addi	s5,s5,1542 # 69f8 <lock_release+0xc18>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	56650513          	addi	a0,a0,1382 # 69c8 <lock_release+0xbe8>
    ...
    1482:	56250513          	addi	a0,a0,1378 # 69e0 <lock_release+0xc00>
    ...
    14a0:	56c50513          	addi	a0,a0,1388 # 6a08 <lock_release+0xc28>
    ...
    14be:	d2ea0a13          	addi	s4,s4,-722 # 61e8 <lock_release+0x408>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	566a8a93          	addi	s5,s5,1382 # 6a28 <lock_release+0xc48>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	cdc50513          	addi	a0,a0,-804 # 61e8 <lock_release+0x408>
  ...
  exit(xstatus);
    ...
    152e:	4b650513          	addi	a0,a0,1206 # 69e0 <lock_release+0xc00>
    ...
    154c:	4e850513          	addi	a0,a0,1256 # 6a30 <lock_release+0xc50>
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	c2078793          	addi	a5,a5,-992 # 6190 <lock_release+0x3b0>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	4d478793          	addi	a5,a5,1236 # 6a50 <lock_release+0xc70>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	4cc50513          	addi	a0,a0,1228 # 6a58 <lock_release+0xc78>
  ...
  if(pid == 0) {
    ...
    15be:	49e50513          	addi	a0,a0,1182 # 6a58 <lock_release+0xc78>
    ...
    15da:	4a250513          	addi	a0,a0,1186 # 6a78 <lock_release+0xc98>
    ...
    15f6:	3d650513          	addi	a0,a0,982 # 69c8 <lock_release+0xbe8>
    ...
    1612:	45250513          	addi	a0,a0,1106 # 6a60 <lock_release+0xc80>
    ...
    1630:	b6450513          	addi	a0,a0,-1180 # 6190 <lock_release+0x3b0>
  ...
  if(xstatus != 0)
    ...
    1664:	42850513          	addi	a0,a0,1064 # 6a88 <lock_release+0xca8>
    ...
    1680:	42450513          	addi	a0,a0,1060 # 6aa0 <lock_release+0xcc0>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1694:	3c850513          	addi	a0,a0,968 # 6a58 <lock_release+0xc78>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	e6650513          	addi	a0,a0,-410 # 6520 <lock_release+0x740>
    ...
    16da:	30a50513          	addi	a0,a0,778 # 69e0 <lock_release+0xc00>
  ...
  unlink("echo-ok");
    ...
    16f4:	36850513          	addi	a0,a0,872 # 6a58 <lock_release+0xc78>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	39e50513          	addi	a0,a0,926 # 6ab8 <lock_release+0xcd8>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	692a8a93          	addi	s5,s5,1682 # be18 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	67470713          	addi	a4,a4,1652 # be18 <buf>
    ...
    17e0:	2f450513          	addi	a0,a0,756 # 6ad0 <lock_release+0xcf0>
    ...
    1806:	616b0b13          	addi	s6,s6,1558 # be18 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	28650513          	addi	a0,a0,646 # 6ae8 <lock_release+0xd08>
    ...
    1882:	28250513          	addi	a0,a0,642 # 6b00 <lock_release+0xd20>
    ...
    18b4:	26850513          	addi	a0,a0,616 # 6b18 <lock_release+0xd38>
    ...
    18f4:	24850513          	addi	a0,a0,584 # 6b38 <lock_release+0xd58>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	06650513          	addi	a0,a0,102 # 69c8 <lock_release+0xbe8>
    ...
    1982:	1d250513          	addi	a0,a0,466 # 6b50 <lock_release+0xd70>
    ...
    199e:	1ce50513          	addi	a0,a0,462 # 6b68 <lock_release+0xd88>
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	fb650513          	addi	a0,a0,-74 # 69c8 <lock_release+0xbe8>
    ...
    1a3a:	f9250513          	addi	a0,a0,-110 # 69c8 <lock_release+0xbe8>
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	0d850513          	addi	a0,a0,216 # 6b88 <lock_release+0xda8>
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	09050513          	addi	a0,a0,144 # 6b98 <lock_release+0xdb8>
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	29250513          	addi	a0,a0,658 # 6de8 <lock_release+0x1008>
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	1f450513          	addi	a0,a0,500 # 6de8 <lock_release+0x1008>
    ...
    1c24:	e4050513          	addi	a0,a0,-448 # 6a60 <lock_release+0xc80>
    ...
    1c96:	f2650513          	addi	a0,a0,-218 # 6bb8 <lock_release+0xdd8>
    ...
    1cca:	f0a50513          	addi	a0,a0,-246 # 6bd0 <lock_release+0xdf0>
    ...
    1d30:	ecc50513          	addi	a0,a0,-308 # 6bf8 <lock_release+0xe18>
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	43450513          	addi	a0,a0,1076 # 6200 <lock_release+0x420>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	3f8a8a93          	addi	s5,s5,1016 # 6200 <lock_release+0x420>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	e10b8b93          	addi	s7,s7,-496 # 6c20 <lock_release+0xe40>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	bac50513          	addi	a0,a0,-1108 # 69c8 <lock_release+0xbe8>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	ede50513          	addi	a0,a0,-290 # 6de8 <lock_release+0x1008>
    ...
    1f4a:	ed2b8b93          	addi	s7,s7,-302 # be18 <buf>
    ...
    1fbe:	c6e50513          	addi	a0,a0,-914 # 6c28 <lock_release+0xe48>
    ...
    1fde:	27650513          	addi	a0,a0,630 # 6250 <lock_release+0x470>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	c3050513          	addi	a0,a0,-976 # 6c58 <lock_release+0xe78>
  ...
  if(wait(0) != -1){
    ...
    208e:	bb650513          	addi	a0,a0,-1098 # 6c40 <lock_release+0xe60>
    ...
    20aa:	bda50513          	addi	a0,a0,-1062 # 6c80 <lock_release+0xea0>
    ...
    20c6:	bd650513          	addi	a0,a0,-1066 # 6c98 <lock_release+0xeb8>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x538>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e658>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	88650513          	addi	a0,a0,-1914 # 69c8 <lock_release+0xbe8>
    ...
    2168:	b4c50513          	addi	a0,a0,-1204 # 6cb0 <lock_release+0xed0>
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	7e250513          	addi	a0,a0,2018 # 69c8 <lock_release+0xbe8>
    ...
    2216:	abe50513          	addi	a0,a0,-1346 # 6cd0 <lock_release+0xef0>
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	aa650513          	addi	a0,a0,-1370 # 6ce8 <lock_release+0xf08>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a7450513          	addi	a0,a0,-1420 # 6ce8 <lock_release+0xf08>
  ...
  close(fd);
    ...
    229e:	36678793          	addi	a5,a5,870 # 8600 <args.1861>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	45668693          	addi	a3,a3,1110 # 86f8 <args.1861+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	a4e70713          	addi	a4,a4,-1458 # 6cf8 <lock_release+0xf18>
    ...
    2302:	ada50513          	addi	a0,a0,-1318 # 6dd8 <lock_release+0xff8>
    ...
    2326:	ad650513          	addi	a0,a0,-1322 # 6df8 <lock_release+0x1018>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff01d8>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	a9850513          	addi	a0,a0,-1384 # 6e18 <lock_release+0x1038>
    ...
    23a0:	62c50513          	addi	a0,a0,1580 # 69c8 <lock_release+0xbe8>
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	67a78793          	addi	a5,a5,1658 # 7ab0 <lock_release+0x1cd0>
  ...
  if(ret != -1){
    ...
    247c:	9c850513          	addi	a0,a0,-1592 # 6e40 <lock_release+0x1060>
    ...
    249a:	45250513          	addi	a0,a0,1106 # 68e8 <lock_release+0xb08>
    ...
    24b8:	45450513          	addi	a0,a0,1108 # 6908 <lock_release+0xb28>
    ...
    24d8:	45450513          	addi	a0,a0,1108 # 6928 <lock_release+0xb48>
    ...
    24f6:	45e50513          	addi	a0,a0,1118 # 6950 <lock_release+0xb70>
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	94250513          	addi	a0,a0,-1726 # 5e80 <lock_release+0xa0>
  ...
  if(n >= 0){
    ...
    2574:	92850513          	addi	a0,a0,-1752 # 6e98 <lock_release+0x10b8>
    ...
    258e:	8be50513          	addi	a0,a0,-1858 # 6e48 <lock_release+0x1068>
    ...
    25a8:	8bc50513          	addi	a0,a0,-1860 # 6e60 <lock_release+0x1080>
    ...
    25c2:	8c250513          	addi	a0,a0,-1854 # 6e80 <lock_release+0x10a0>
  ...
  unlink("rwsbrk");
    ...
    25e6:	89e50513          	addi	a0,a0,-1890 # 5e80 <lock_release+0xa0>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	d3450513          	addi	a0,a0,-716 # 6328 <lock_release+0x548>
  ...
  if(n >= 0){
    ...
    2622:	8aa50513          	addi	a0,a0,-1878 # 6ec8 <lock_release+0x10e8>
    ...
    263c:	84850513          	addi	a0,a0,-1976 # 6e80 <lock_release+0x10a0>
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff11d8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	83650513          	addi	a0,a0,-1994 # 6ef0 <lock_release+0x1110>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	80250513          	addi	a0,a0,-2046 # 6f10 <lock_release+0x1130>
  ...
  if(c != a + 1){
    ...
    2774:	80050513          	addi	a0,a0,-2048 # 6f70 <lock_release+0x1190>
    ...
    2796:	79e50513          	addi	a0,a0,1950 # 6f30 <lock_release+0x1150>
    ...
    27b2:	7a250513          	addi	a0,a0,1954 # 6f50 <lock_release+0x1170>
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11d7>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11d7>
  ...
  if(c != a){
    ...
    28fc:	69850513          	addi	a0,a0,1688 # 6f90 <lock_release+0x11b0>
    ...
    2918:	6c450513          	addi	a0,a0,1732 # 6fd8 <lock_release+0x11f8>
    ...
    2938:	6c450513          	addi	a0,a0,1732 # 6ff8 <lock_release+0x1218>
    ...
    2958:	6e450513          	addi	a0,a0,1764 # 7038 <lock_release+0x1258>
    ...
    2974:	6f850513          	addi	a0,a0,1784 # 7068 <lock_release+0x1288>
    ...
    2994:	71050513          	addi	a0,a0,1808 # 70a0 <lock_release+0x12c0>
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	6fe50513          	addi	a0,a0,1790 # 70c8 <lock_release+0x12e8>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	6ec50513          	addi	a0,a0,1772 # 70c8 <lock_release+0x12e8>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	6a050513          	addi	a0,a0,1696 # 70d0 <lock_release+0x12f0>
    ...
    2a50:	69c50513          	addi	a0,a0,1692 # 70e8 <lock_release+0x1308>
    ...
    2a6c:	06850513          	addi	a0,a0,104 # 6ad0 <lock_release+0xcf0>
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	66e50513          	addi	a0,a0,1646 # 7100 <lock_release+0x1320>
  ...
  close(fd);
    ...
    2ade:	f0650513          	addi	a0,a0,-250 # 69e0 <lock_release+0xc00>
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	2c050513          	addi	a0,a0,704 # 6de8 <lock_release+0x1008>
  ...
  if(pid == 0){
    ...
    2b82:	26a50513          	addi	a0,a0,618 # 6de8 <lock_release+0x1008>
  ...
  if(pid == 0){
    ...
    2be2:	20a50513          	addi	a0,a0,522 # 6de8 <lock_release+0x1008>
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff11d7>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	09650513          	addi	a0,a0,150 # 6de8 <lock_release+0x1008>
    ...
    2daa:	3ea50513          	addi	a0,a0,1002 # 6190 <lock_release+0x3b0>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	44e78793          	addi	a5,a5,1102 # 6200 <lock_release+0x420>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	4f450513          	addi	a0,a0,1268 # 72d8 <lock_release+0x14f8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	33a50513          	addi	a0,a0,826 # 7130 <lock_release+0x1350>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	37c50513          	addi	a0,a0,892 # 7188 <lock_release+0x13a8>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	3d650513          	addi	a0,a0,982 # 7200 <lock_release+0x1420>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	42a50513          	addi	a0,a0,1066 # 7270 <lock_release+0x1490>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	47050513          	addi	a0,a0,1136 # 72c8 <lock_release+0x14e8>
  ...
  unlink("12345678901234");
    ...
    2eda:	23250513          	addi	a0,a0,562 # 7108 <lock_release+0x1328>
    ...
    2ef6:	25e50513          	addi	a0,a0,606 # 7150 <lock_release+0x1370>
    ...
    2f12:	2aa50513          	addi	a0,a0,682 # 71b8 <lock_release+0x13d8>
    ...
    2f2e:	30650513          	addi	a0,a0,774 # 7230 <lock_release+0x1450>
    ...
    2f4a:	34a50513          	addi	a0,a0,842 # 7290 <lock_release+0x14b0>
    ...
    2f66:	38650513          	addi	a0,a0,902 # 72e8 <lock_release+0x1508>
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	39850513          	addi	a0,a0,920 # 7320 <lock_release+0x1540>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	38450513          	addi	a0,a0,900 # 7320 <lock_release+0x1540>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	3b050513          	addi	a0,a0,944 # 7360 <lock_release+0x1580>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	3cc50513          	addi	a0,a0,972 # 7390 <lock_release+0x15b0>
    ...
    2fe8:	34450513          	addi	a0,a0,836 # 7328 <lock_release+0x1548>
    ...
    3004:	34050513          	addi	a0,a0,832 # 7340 <lock_release+0x1560>
    ...
    3020:	35450513          	addi	a0,a0,852 # 7370 <lock_release+0x1590>
    ...
    303c:	36050513          	addi	a0,a0,864 # 7398 <lock_release+0x15b8>
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	2b450513          	addi	a0,a0,692 # 7320 <lock_release+0x1540>
    ...
    3084:	2a050513          	addi	a0,a0,672 # 7320 <lock_release+0x1540>
    ...
    3098:	2cc50513          	addi	a0,a0,716 # 7360 <lock_release+0x1580>
    ...
    30b8:	91450513          	addi	a0,a0,-1772 # 69c8 <lock_release+0xbe8>
    ...
    30d4:	25850513          	addi	a0,a0,600 # 7328 <lock_release+0x1548>
    ...
    30f0:	2c450513          	addi	a0,a0,708 # 73b0 <lock_release+0x15d0>
    ...
    310c:	26850513          	addi	a0,a0,616 # 7370 <lock_release+0x1590>
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	28250513          	addi	a0,a0,642 # 73c8 <lock_release+0x15e8>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	26e50513          	addi	a0,a0,622 # 73c8 <lock_release+0x15e8>
  ...
  if(chdir("..") < 0){
    ...
    3172:	27a50513          	addi	a0,a0,634 # 73e8 <lock_release+0x1608>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	24650513          	addi	a0,a0,582 # 73c8 <lock_release+0x15e8>
    ...
    31a6:	18650513          	addi	a0,a0,390 # 7328 <lock_release+0x1548>
    ...
    31c2:	21250513          	addi	a0,a0,530 # 73d0 <lock_release+0x15f0>
    ...
    31de:	21650513          	addi	a0,a0,534 # 73f0 <lock_release+0x1610>
    ...
    31fa:	21250513          	addi	a0,a0,530 # 7408 <lock_release+0x1628>
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	33250513          	addi	a0,a0,818 # 7550 <lock_release+0x1770>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	1f250513          	addi	a0,a0,498 # 7420 <lock_release+0x1640>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	1fa50513          	addi	a0,a0,506 # 7440 <lock_release+0x1660>
  ...
  write(fd, "ff", 2);
    ...
    3262:	2f258593          	addi	a1,a1,754 # 7550 <lock_release+0x1770>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	1a850513          	addi	a0,a0,424 # 7420 <lock_release+0x1640>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	20c50513          	addi	a0,a0,524 # 7498 <lock_release+0x16b8>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	21c50513          	addi	a0,a0,540 # 74c0 <lock_release+0x16e0>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	23458593          	addi	a1,a1,564 # 74f0 <lock_release+0x1710>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	22050513          	addi	a0,a0,544 # 74f8 <lock_release+0x1718>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	b2858593          	addi	a1,a1,-1240 # be18 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	b1274703          	lbu	a4,-1262(a4) # be18 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	22858593          	addi	a1,a1,552 # 7548 <lock_release+0x1768>
    3328:	00004517          	auipc	a0,0x4
    332c:	19850513          	addi	a0,a0,408 # 74c0 <lock_release+0x16e0>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	18450513          	addi	a0,a0,388 # 74c0 <lock_release+0x16e0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	16e50513          	addi	a0,a0,366 # 74c0 <lock_release+0x16e0>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	0ba50513          	addi	a0,a0,186 # 7420 <lock_release+0x1640>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	26650513          	addi	a0,a0,614 # 75e0 <lock_release+0x1800>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	28250513          	addi	a0,a0,642 # 7610 <lock_release+0x1830>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	29e50513          	addi	a0,a0,670 # 7640 <lock_release+0x1860>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	19050513          	addi	a0,a0,400 # 7548 <lock_release+0x1768>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	a4858593          	addi	a1,a1,-1464 # be18 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	0ce50513          	addi	a0,a0,206 # 74c0 <lock_release+0x16e0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	2c650513          	addi	a0,a0,710 # 76d0 <lock_release+0x18f0>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	2de50513          	addi	a0,a0,734 # 7700 <lock_release+0x1920>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	fe650513          	addi	a0,a0,-26 # 7420 <lock_release+0x1640>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	fd050513          	addi	a0,a0,-48 # 7420 <lock_release+0x1640>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	fba50513          	addi	a0,a0,-70 # 7420 <lock_release+0x1640>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	31658593          	addi	a1,a1,790 # 7790 <lock_release+0x19b0>
    3482:	00004517          	auipc	a0,0x4
    3486:	24e50513          	addi	a0,a0,590 # 76d0 <lock_release+0x18f0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	2fa58593          	addi	a1,a1,762 # 7790 <lock_release+0x19b0>
    349e:	00004517          	auipc	a0,0x4
    34a2:	26250513          	addi	a0,a0,610 # 7700 <lock_release+0x1920>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	09658593          	addi	a1,a1,150 # 7548 <lock_release+0x1768>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f8650513          	addi	a0,a0,-122 # 7440 <lock_release+0x1660>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	20250513          	addi	a0,a0,514 # 76d0 <lock_release+0x18f0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	21e50513          	addi	a0,a0,542 # 7700 <lock_release+0x1920>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	05250513          	addi	a0,a0,82 # 7548 <lock_release+0x1768>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	1f650513          	addi	a0,a0,502 # 7700 <lock_release+0x1920>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	1b250513          	addi	a0,a0,434 # 76d0 <lock_release+0x18f0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	f0e50513          	addi	a0,a0,-242 # 7440 <lock_release+0x1660>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	39a50513          	addi	a0,a0,922 # 78e0 <lock_release+0x1b00>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	fee50513          	addi	a0,a0,-18 # 7548 <lock_release+0x1768>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	ed250513          	addi	a0,a0,-302 # 7440 <lock_release+0x1660>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e9e50513          	addi	a0,a0,-354 # 7420 <lock_release+0x1640>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	3ba50513          	addi	a0,a0,954 # 7950 <lock_release+0x1b70>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e7650513          	addi	a0,a0,-394 # 7420 <lock_release+0x1640>
    ...
    35d0:	e5c50513          	addi	a0,a0,-420 # 7428 <lock_release+0x1648>
    ...
    35ec:	e6050513          	addi	a0,a0,-416 # 7448 <lock_release+0x1668>
    ...
    3608:	e6450513          	addi	a0,a0,-412 # 7468 <lock_release+0x1688>
    ...
    3624:	e8050513          	addi	a0,a0,-384 # 74a0 <lock_release+0x16c0>
    ...
    3640:	e9450513          	addi	a0,a0,-364 # 74d0 <lock_release+0x16f0>
    ...
    365c:	eb050513          	addi	a0,a0,-336 # 7508 <lock_release+0x1728>
    ...
    3678:	eb450513          	addi	a0,a0,-332 # 7528 <lock_release+0x1748>
    ...
    3694:	ec850513          	addi	a0,a0,-312 # 7558 <lock_release+0x1778>
    ...
    36b0:	ed450513          	addi	a0,a0,-300 # 7580 <lock_release+0x17a0>
    ...
    36cc:	ed850513          	addi	a0,a0,-296 # 75a0 <lock_release+0x17c0>
    ...
    36e8:	ee450513          	addi	a0,a0,-284 # 75c8 <lock_release+0x17e8>
    ...
    3704:	ef050513          	addi	a0,a0,-272 # 75f0 <lock_release+0x1810>
    ...
    3720:	f0450513          	addi	a0,a0,-252 # 7620 <lock_release+0x1840>
    ...
    373c:	f1050513          	addi	a0,a0,-240 # 7648 <lock_release+0x1868>
    ...
    3758:	f0c50513          	addi	a0,a0,-244 # 7660 <lock_release+0x1880>
    ...
    3774:	f1050513          	addi	a0,a0,-240 # 7680 <lock_release+0x18a0>
    ...
    3790:	f1450513          	addi	a0,a0,-236 # 76a0 <lock_release+0x18c0>
    ...
    37ac:	f3850513          	addi	a0,a0,-200 # 76e0 <lock_release+0x1900>
    ...
    37c8:	f4c50513          	addi	a0,a0,-180 # 7710 <lock_release+0x1930>
    ...
    37e4:	f5050513          	addi	a0,a0,-176 # 7730 <lock_release+0x1950>
    ...
    3800:	f5450513          	addi	a0,a0,-172 # 7750 <lock_release+0x1970>
    ...
    381c:	f5850513          	addi	a0,a0,-168 # 7770 <lock_release+0x1990>
    ...
    3838:	f6c50513          	addi	a0,a0,-148 # 77a0 <lock_release+0x19c0>
    ...
    3854:	f7850513          	addi	a0,a0,-136 # 77c8 <lock_release+0x19e8>
    ...
    3870:	f8450513          	addi	a0,a0,-124 # 77f0 <lock_release+0x1a10>
    ...
    388c:	f9050513          	addi	a0,a0,-112 # 7818 <lock_release+0x1a38>
    ...
    38a8:	f9450513          	addi	a0,a0,-108 # 7838 <lock_release+0x1a58>
    ...
    38c4:	f9850513          	addi	a0,a0,-104 # 7858 <lock_release+0x1a78>
    ...
    38e0:	fa450513          	addi	a0,a0,-92 # 7880 <lock_release+0x1aa0>
    ...
    38fc:	fa850513          	addi	a0,a0,-88 # 78a0 <lock_release+0x1ac0>
    ...
    3918:	fac50513          	addi	a0,a0,-84 # 78c0 <lock_release+0x1ae0>
    ...
    3934:	fb850513          	addi	a0,a0,-72 # 78e8 <lock_release+0x1b08>
    ...
    3950:	c3450513          	addi	a0,a0,-972 # 7580 <lock_release+0x17a0>
    ...
    396c:	fa050513          	addi	a0,a0,-96 # 7908 <lock_release+0x1b28>
    ...
    3988:	fa450513          	addi	a0,a0,-92 # 7928 <lock_release+0x1b48>
    ...
    39a4:	fb850513          	addi	a0,a0,-72 # 7958 <lock_release+0x1b78>
    ...
    39c0:	fbc50513          	addi	a0,a0,-68 # 7978 <lock_release+0x1b98>
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	fae50513          	addi	a0,a0,-82 # 7990 <lock_release+0x1bb0>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f9c50513          	addi	a0,a0,-100 # 7990 <lock_release+0x1bb0>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	e2250513          	addi	a0,a0,-478 # 6828 <lock_release+0xa48>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	9d050513          	addi	a0,a0,-1584 # 73e8 <lock_release+0x1608>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	96650513          	addi	a0,a0,-1690 # 7390 <lock_release+0x15b0>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	fbc50513          	addi	a0,a0,-68 # 79f8 <lock_release+0x1c18>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	fd250513          	addi	a0,a0,-46 # 7a20 <lock_release+0x1c40>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	f3050513          	addi	a0,a0,-208 # 7990 <lock_release+0x1bb0>
    ...
    3a82:	f1a50513          	addi	a0,a0,-230 # 7998 <lock_release+0x1bb8>
    ...
    3a9e:	f1650513          	addi	a0,a0,-234 # 79b0 <lock_release+0x1bd0>
    ...
    3aba:	f1250513          	addi	a0,a0,-238 # 79c8 <lock_release+0x1be8>
    ...
    3ad6:	f0e50513          	addi	a0,a0,-242 # 79e0 <lock_release+0x1c00>
    ...
    3af2:	8aa50513          	addi	a0,a0,-1878 # 7398 <lock_release+0x15b8>
    ...
    3b0e:	ef650513          	addi	a0,a0,-266 # 7a00 <lock_release+0x1c20>
    ...
    3b2a:	f0250513          	addi	a0,a0,-254 # 7a28 <lock_release+0x1c48>
    ...
    3b46:	f0650513          	addi	a0,a0,-250 # 7a48 <lock_release+0x1c68>
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	5c250513          	addi	a0,a0,1474 # 6130 <lock_release+0x350>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	5a650513          	addi	a0,a0,1446 # 6130 <lock_release+0x350>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	f0a50513          	addi	a0,a0,-246 # 7aa8 <lock_release+0x1cc8>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	ef250513          	addi	a0,a0,-270 # 7aa8 <lock_release+0x1cc8>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	ede50513          	addi	a0,a0,-290 # 7aa8 <lock_release+0x1cc8>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	eca50513          	addi	a0,a0,-310 # 7aa8 <lock_release+0x1cc8>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	eb658593          	addi	a1,a1,-330 # 7aa8 <lock_release+0x1cc8>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	72e50513          	addi	a0,a0,1838 # 6328 <lock_release+0x548>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	52250513          	addi	a0,a0,1314 # 6130 <lock_release+0x350>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	c0450513          	addi	a0,a0,-1020 # 6828 <lock_release+0xa48>
  ...
  fd = open(".", 0);
    ...
    3c3e:	bee50513          	addi	a0,a0,-1042 # 6828 <lock_release+0xa48>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	5b258593          	addi	a1,a1,1458 # 6200 <lock_release+0x420>
  ...
  close(fd);
    ...
    3c7e:	dee50513          	addi	a0,a0,-530 # 7a68 <lock_release+0x1c88>
    ...
    3c9a:	df250513          	addi	a0,a0,-526 # 7a88 <lock_release+0x1ca8>
    ...
    3cb6:	e0650513          	addi	a0,a0,-506 # 7ab8 <lock_release+0x1cd8>
    ...
    3cd2:	dea50513          	addi	a0,a0,-534 # 7ab8 <lock_release+0x1cd8>
    ...
    3cee:	df650513          	addi	a0,a0,-522 # 7ae0 <lock_release+0x1d00>
    ...
    3d0a:	e0250513          	addi	a0,a0,-510 # 7b08 <lock_release+0x1d28>
    ...
    3d26:	e0e50513          	addi	a0,a0,-498 # 7b30 <lock_release+0x1d50>
    ...
    3d42:	e1a50513          	addi	a0,a0,-486 # 7b58 <lock_release+0x1d78>
    ...
    3d5e:	e1e50513          	addi	a0,a0,-482 # 7b78 <lock_release+0x1d98>
    ...
    3d7a:	e2a50513          	addi	a0,a0,-470 # 7ba0 <lock_release+0x1dc0>
...
0000000000003d90 <iref>:
{
    ...
    3dae:	e0ea0a13          	addi	s4,s4,-498 # 7bb8 <lock_release+0x1dd8>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	91648493          	addi	s1,s1,-1770 # 76c8 <lock_release+0x18e8>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	56ea8a93          	addi	s5,s5,1390 # 6328 <lock_release+0x548>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	cee98993          	addi	s3,s3,-786 # 7ab0 <lock_release+0x1cd0>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	df250513          	addi	a0,a0,-526 # 7bc0 <lock_release+0x1de0>
    ...
    3dee:	dee50513          	addi	a0,a0,-530 # 7bd8 <lock_release+0x1df8>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	56a98993          	addi	s3,s3,1386 # 73e8 <lock_release+0x1608>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	d3290913          	addi	s2,s2,-718 # 7bb8 <lock_release+0x1dd8>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	4ea50513          	addi	a0,a0,1258 # 7390 <lock_release+0x15b0>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	d1a50513          	addi	a0,a0,-742 # 7bf0 <lock_release+0x1e10>
  ...
  if(pid == 0){
    ...
    3efe:	cf650513          	addi	a0,a0,-778 # 7bf0 <lock_release+0x1e10>
    ...
    3f14:	d0050513          	addi	a0,a0,-768 # 7c10 <lock_release+0x1e30>
    ...
    3f30:	ccc50513          	addi	a0,a0,-820 # 7bf8 <lock_release+0x1e18>
    ...
    3f4c:	a8050513          	addi	a0,a0,-1408 # 69c8 <lock_release+0xbe8>
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c7a50513          	addi	a0,a0,-902 # 7bf0 <lock_release+0x1e10>
    ...
    3f8e:	c2e50513          	addi	a0,a0,-978 # 6bb8 <lock_release+0xdd8>
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c7050513          	addi	a0,a0,-912 # 7c38 <lock_release+0x1e58>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	c4450513          	addi	a0,a0,-956 # 7c38 <lock_release+0x1e58>
  ...
  sleep(10); // one second
    ...
    4030:	b5c50513          	addi	a0,a0,-1188 # 6b88 <lock_release+0xda8>
    ...
    404a:	bf248493          	addi	s1,s1,-1038 # 7c38 <lock_release+0x1e58>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	8da50513          	addi	a0,a0,-1830 # 69c8 <lock_release+0xbe8>
    ...
    4118:	b3450513          	addi	a0,a0,-1228 # 7c48 <lock_release+0x1e68>
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	a3450513          	addi	a0,a0,-1484 # 6b88 <lock_release+0xda8>
  ...
  if(pid2 == 0)
    ...
    4186:	84650513          	addi	a0,a0,-1978 # 69c8 <lock_release+0xbe8>
  ...
  if(pid3 == 0){
    ...
    41ca:	03a58593          	addi	a1,a1,58 # 6200 <lock_release+0x420>
    ...
    41f4:	7d850513          	addi	a0,a0,2008 # 69c8 <lock_release+0xbe8>
    ...
    4210:	a5c50513          	addi	a0,a0,-1444 # 7c68 <lock_release+0x1e88>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	bec58593          	addi	a1,a1,-1044 # be18 <buf>
    ...
    424c:	a3850513          	addi	a0,a0,-1480 # 7c80 <lock_release+0x1ea0>
  ...
  printf("kill... ");
    ...
    4278:	a2450513          	addi	a0,a0,-1500 # 7c98 <lock_release+0x1eb8>
  ...
  printf("wait... ");
    ...
    42a6:	a0650513          	addi	a0,a0,-1530 # 7ca8 <lock_release+0x1ec8>
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	6a650513          	addi	a0,a0,1702 # 69c8 <lock_release+0xbe8>
    ...
    4342:	81250513          	addi	a0,a0,-2030 # 6b50 <lock_release+0xd70>
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	71c50513          	addi	a0,a0,1820 # 6ad0 <lock_release+0xcf0>
    ...
    43ee:	e1658593          	addi	a1,a1,-490 # 6200 <lock_release+0x420>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	80a50513          	addi	a0,a0,-2038 # 7cb8 <lock_release+0x1ed8>
    ...
    44ce:	4fe50513          	addi	a0,a0,1278 # 69c8 <lock_release+0xbe8>
    ...
    451a:	7c250513          	addi	a0,a0,1986 # 7cd8 <lock_release+0x1ef8>
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    45a2:	76a50513          	addi	a0,a0,1898 # 7d08 <lock_release+0x1f28>
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	6b650513          	addi	a0,a0,1718 # 7d28 <lock_release+0x1f48>
    ...
    4692:	6c250513          	addi	a0,a0,1730 # 7d50 <lock_release+0x1f70>
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	8ce50513          	addi	a0,a0,-1842 # 5fa0 <lock_release+0x1c0>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	65e50513          	addi	a0,a0,1630 # 7d70 <lock_release+0x1f90>
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f11d8>
  ...
  unlink("sharedfd");
    ...
    4752:	85250513          	addi	a0,a0,-1966 # 5fa0 <lock_release+0x1c0>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	62450513          	addi	a0,a0,1572 # 7d98 <lock_release+0x1fb8>
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	64078793          	addi	a5,a5,1600 # 5df8 <lock_release+0x18>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	63c78793          	addi	a5,a5,1596 # 5e00 <lock_release+0x20>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	63878793          	addi	a5,a5,1592 # 5e08 <lock_release+0x28>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	63478793          	addi	a5,a5,1588 # 5e10 <lock_release+0x30>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	5e2a0a13          	addi	s4,s4,1506 # be18 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	5dba8a93          	addi	s5,s5,1499 # be19 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	59450513          	addi	a0,a0,1428 # 6de8 <lock_release+0x1008>
    ...
    48d2:	4e250513          	addi	a0,a0,1250 # 7db0 <lock_release+0x1fd0>
    ...
    48ec:	4d850513          	addi	a0,a0,1240 # 7dc0 <lock_release+0x1fe0>
    ...
    4910:	4cc50513          	addi	a0,a0,1228 # 7dd8 <lock_release+0x1ff8>
    ...
    4940:	4dc78793          	addi	a5,a5,1244 # be18 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	44c50513          	addi	a0,a0,1100 # 7de8 <lock_release+0x2008>
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	402b8b93          	addi	s7,s7,1026 # 7e00 <lock_release+0x2020>
  for(i = 0; i < N; i++){
    ...
    4a44:	3c850513          	addi	a0,a0,968 # 7e08 <lock_release+0x2028>
    ...
    4a62:	3a250513          	addi	a0,a0,930 # 7e00 <lock_release+0x2020>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d9250513          	addi	a0,a0,-622 # 6828 <lock_release+0xa48>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	36c50513          	addi	a0,a0,876 # 7e28 <lock_release+0x2048>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	31c50513          	addi	a0,a0,796 # 7e48 <lock_release+0x2068>
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	30c50513          	addi	a0,a0,780 # 7e70 <lock_release+0x2090>
    ...
    4b84:	e4850513          	addi	a0,a0,-440 # 69c8 <lock_release+0xbe8>
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	0ae90913          	addi	s2,s2,174 # be18 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	0f650513          	addi	a0,a0,246 # 7ea8 <lock_release+0x20c8>
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	05090913          	addi	s2,s2,80 # be18 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	0a250513          	addi	a0,a0,162 # 7eb8 <lock_release+0x20d8>
    ...
    4e36:	0a650513          	addi	a0,a0,166 # 7ed8 <lock_release+0x20f8>
    ...
    4e52:	0aa50513          	addi	a0,a0,170 # 7ef8 <lock_release+0x2118>
    ...
    4e6e:	0ae50513          	addi	a0,a0,174 # 7f18 <lock_release+0x2138>
    ...
    4e8a:	0b250513          	addi	a0,a0,178 # 7f38 <lock_release+0x2158>
    ...
    4ea6:	0ae50513          	addi	a0,a0,174 # 7f50 <lock_release+0x2170>
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	fd850513          	addi	a0,a0,-40 # 7ea8 <lock_release+0x20c8>
    ...
    4ef8:	07c50513          	addi	a0,a0,124 # 7f70 <lock_release+0x2190>
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	06450513          	addi	a0,a0,100 # 7f90 <lock_release+0x21b0>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4f50:	054c8c93          	addi	s9,s9,84 # 7fa0 <lock_release+0x21c0>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	ec2a0a13          	addi	s4,s4,-318 # be18 <buf>
    name[0] = 'f';
    ...
    4fca:	fea50513          	addi	a0,a0,-22 # 7fb0 <lock_release+0x21d0>
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f9450513          	addi	a0,a0,-108 # 7fd0 <lock_release+0x21f0>
    ...
    5090:	f3450513          	addi	a0,a0,-204 # 7fc0 <lock_release+0x21e0>
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	eca50513          	addi	a0,a0,-310 # 7fe8 <lock_release+0x2208>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	0ca58593          	addi	a1,a1,202 # 6200 <lock_release+0x420>
    ...
    5150:	ebc50513          	addi	a0,a0,-324 # 8008 <lock_release+0x2228>
    ...
    516a:	e8a50513          	addi	a0,a0,-374 # 7ff0 <lock_release+0x2210>
    ...
    5184:	e7050513          	addi	a0,a0,-400 # 7ff0 <lock_release+0x2210>
  ...
  unlink("junk");
    ...
    51a8:	e4450513          	addi	a0,a0,-444 # 7fe8 <lock_release+0x2208>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	00690913          	addi	s2,s2,6 # 6200 <lock_release+0x420>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	e2a50513          	addi	a0,a0,-470 # 8058 <lock_release+0x2278>
    ...
    524c:	dd050513          	addi	a0,a0,-560 # 8018 <lock_release+0x2238>
    ...
    5266:	dd650513          	addi	a0,a0,-554 # 8038 <lock_release+0x2258>
  ...
  while(1){
    ...
    52b4:	dc850513          	addi	a0,a0,-568 # 8078 <lock_release+0x2298>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d9850513          	addi	a0,a0,-616 # 8098 <lock_release+0x22b8>
  ...
  if(pid == 0) {
    ...
    5334:	d9050513          	addi	a0,a0,-624 # 80c0 <lock_release+0x22e0>
    ...
    5358:	d5450513          	addi	a0,a0,-684 # 80a8 <lock_release+0x22c8>
    ...
    5380:	d4c50513          	addi	a0,a0,-692 # 80c8 <lock_release+0x22e8>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	e1a78793          	addi	a5,a5,-486 # 81e0 <lock_release+0x2400>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	1fe30313          	addi	t1,t1,510 # 85d0 <lock_release+0x27f0>
  ...
  printf("usertests starting\n");
    ...
    540a:	d7a50513          	addi	a0,a0,-646 # 8180 <lock_release+0x23a0>
  ...
  if(fail){
    ...
    5442:	cfa50513          	addi	a0,a0,-774 # 8138 <lock_release+0x2358>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c7658593          	addi	a1,a1,-906 # 80d0 <lock_release+0x22f0>
    ...
    5474:	d4858593          	addi	a1,a1,-696 # 81b8 <lock_release+0x23d8>
    ...
    5498:	c4450513          	addi	a0,a0,-956 # 80d8 <lock_release+0x22f8>
  ...
  if(fail){
    ...
    5504:	c2050513          	addi	a0,a0,-992 # 8120 <lock_release+0x2340>
    ...
    551e:	c4e50513          	addi	a0,a0,-946 # 8168 <lock_release+0x2388>
    ...
    557c:	c6878793          	addi	a5,a5,-920 # 81e0 <lock_release+0x2400>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	04c30313          	addi	t1,t1,76 # 85d0 <lock_release+0x27f0>
    ...
    55bc:	be050513          	addi	a0,a0,-1056 # 8198 <lock_release+0x23b8>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	612080e7          	jalr	1554(ra) # 5bd2 <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	b58a8a93          	addi	s5,s5,-1192 # 8120 <lock_release+0x2340>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	b2eb0b13          	addi	s6,s6,-1234 # 8100 <lock_release+0x2320>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5942:	c9a50513          	addi	a0,a0,-870 # 85d8 <digits>
    5946:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5a0e:	bceb8b93          	addi	s7,s7,-1074 # 85d8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5b4e:	a8690913          	addi	s2,s2,-1402 # 85d0 <lock_release+0x27f0>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c16:	9e67b783          	ld	a5,-1562(a5) # 85f8 <freep>
    ...
    5c44:	00e6ea63          	bltu	a3,a4,5c58 <free+0x50>
{
  ...
  freep = p;
    ...
    5c86:	96f73b23          	sd	a5,-1674(a4) # 85f8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5cb8:	94453503          	ld	a0,-1724(a0) # 85f8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5ce0:	91c90913          	addi	s2,s2,-1764 # 85f8 <freep>
  if(p == (char*)-1)
    5ce4:	5afd                	li	s5,-1
    5ce6:	a88d                	j	5d58 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5ce8:	00009797          	auipc	a5,0x9
    5cec:	13078793          	addi	a5,a5,304 # ee18 <base>
    5cf0:	00003717          	auipc	a4,0x3
    5cf4:	90f73423          	sd	a5,-1784(a4) # 85f8 <freep>
    ...
    5d1a:	8ea73123          	sd	a0,-1822(a4) # 85f8 <freep>
      return (void*)(p + 1);
...
0000000000005d74 <thread_create>:
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
    5d74:	1101                	addi	sp,sp,-32
    5d76:	ec06                	sd	ra,24(sp)
    5d78:	e822                	sd	s0,16(sp)
    5d7a:	e426                	sd	s1,8(sp)
    5d7c:	e04a                	sd	s2,0(sp)
    5d7e:	1000                	addi	s0,sp,32
    5d80:	84aa                	mv	s1,a0
    5d82:	892e                	mv	s2,a1
	int threadid;
	void* stack = (void*)malloc(4096 * sizeof(void));
    5d84:	6505                	lui	a0,0x1
    5d86:	00000097          	auipc	ra,0x0
    5d8a:	f0a080e7          	jalr	-246(ra) # 5c90 <malloc>
	threadid  = clone(stack);
    5d8e:	00000097          	auipc	ra,0x0
    5d92:	b64080e7          	jalr	-1180(ra) # 58f2 <clone>
	if(threadid != 0) {
    5d96:	c901                	beqz	a0,5da6 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
    ...
    5d98:	4501                	li	a0,0
    5d9a:	60e2                	ld	ra,24(sp)
    5d9c:	6442                	ld	s0,16(sp)
    5d9e:	64a2                	ld	s1,8(sp)
    5da0:	6902                	ld	s2,0(sp)
    5da2:	6105                	addi	sp,sp,32
    5da4:	8082                	ret
    (*thread_fn) (arg);
    5da6:	854a                	mv	a0,s2
    5da8:	9482                	jalr	s1
    ...
    5db0:	aa6080e7          	jalr	-1370(ra) # 5852 <exit>

0000000000005db4 <lock_init>:

//Lock implementation
void lock_init(lock_t *lock)
{
    5db4:	1141                	addi	sp,sp,-16
    5db6:	e422                	sd	s0,8(sp)
    5db8:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
    5dba:	00052023          	sw	zero,0(a0) # 1000 <bigdir+0x9e>
}
    5dbe:	6422                	ld	s0,8(sp)
    5dc0:	0141                	addi	sp,sp,16
    5dc2:	8082                	ret

0000000000005dc4 <lock_acquire>:

void lock_acquire(lock_t *lock)
{
    5dc4:	1141                	addi	sp,sp,-16
    5dc6:	e422                	sd	s0,8(sp)
    5dc8:	0800                	addi	s0,sp,16
	while(__sync_lock_test_and_set(&lock->unlocked, 1) != 0);
    5dca:	4705                	li	a4,1
    5dcc:	87ba                	mv	a5,a4
    5dce:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    5dd2:	2781                	sext.w	a5,a5
    5dd4:	ffe5                	bnez	a5,5dcc <lock_acquire+0x8>
  ...
  // On RISC-V, this emits a fence instruction.
    ...
    5dda:	6422                	ld	s0,8(sp)
    5ddc:	0141                	addi	sp,sp,16
    5dde:	8082                	ret

0000000000005de0 <lock_release>:
void lock_release(lock_t *lock)
{
    5de0:	1141                	addi	sp,sp,-16
    5de2:	e422                	sd	s0,8(sp)
    5de4:	0800                	addi	s0,sp,16
  // Tell the C compiler and the processor to not move loads or stores
  // past this point, to ensure that the critical section's memory
  // references happen strictly after the lock is acquired.
  // On RISC-V, this emits a fence instruction.
  ...
  //   amoswap.w zero, zero, (s1)
    ...
    5dea:	0f50000f          	fence	iorw,ow
    5dee:	0805202f          	amoswap.w	zero,zero,(a0)
    5df2:	6422                	ld	s0,8(sp)
    5df4:	0141                	addi	sp,sp,16
    5df6:	8082                	ret
