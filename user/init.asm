...
main(void)
{
  ...
  12:	90a50513          	addi	a0,a0,-1782 # 918 <lock_release+0x1c>
  ...
  3a:	8ea90913          	addi	s2,s2,-1814 # 920 <lock_release+0x24>
  3e:	854a                	mv	a0,s2
  ...
  6e:	90650513          	addi	a0,a0,-1786 # 970 <lock_release+0x74>
  ...
  8c:	89050513          	addi	a0,a0,-1904 # 918 <lock_release+0x1c>
  90:	00000097          	auipc	ra,0x0
  94:	326080e7          	jalr	806(ra) # 3b6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	87e50513          	addi	a0,a0,-1922 # 918 <lock_release+0x1c>
  a2:	00000097          	auipc	ra,0x0
  a6:	30c080e7          	jalr	780(ra) # 3ae <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	88c50513          	addi	a0,a0,-1908 # 938 <lock_release+0x3c>
  ...
  ca:	8ea58593          	addi	a1,a1,-1814 # 9b0 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	88250513          	addi	a0,a0,-1918 # 950 <lock_release+0x54>
  d6:	00000097          	auipc	ra,0x0
  da:	2d0080e7          	jalr	720(ra) # 3a6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	87a50513          	addi	a0,a0,-1926 # 958 <lock_release+0x5c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45e:	53e50513          	addi	a0,a0,1342 # 998 <digits>
 462:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52a:	472b8b93          	addi	s7,s7,1138 # 998 <digits>
 ...
 66a:	32a90913          	addi	s2,s2,810 # 990 <lock_release+0x94>
        while(*s != 0){
...
free(void *ap)
{
 ...
 732:	2927b783          	ld	a5,658(a5) # 9c0 <freep>
 ...
 760:	00e6ea63          	bltu	a3,a4,774 <free+0x50>
{
 ...
 7a2:	22f73123          	sd	a5,546(a4) # 9c0 <freep>
}
 7a6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d4:	1f053503          	ld	a0,496(a0) # 9c0 <freep>
 ...
 7fc:	1c890913          	addi	s2,s2,456 # 9c0 <freep>
  if(p == (char*)-1)
 800:	5afd                	li	s5,-1
 802:	a88d                	j	874 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 804:	00000797          	auipc	a5,0x0
 808:	1c478793          	addi	a5,a5,452 # 9c8 <base>
 80c:	00000717          	auipc	a4,0x0
 810:	1af73a23          	sd	a5,436(a4) # 9c0 <freep>
 814:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 836:	18a73723          	sd	a0,398(a4) # 9c0 <freep>
      return (void*)(p + 1);
...
0000000000000890 <thread_create>:
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 8a6:	f0a080e7          	jalr	-246(ra) # 7ac <malloc>
	threadid  = clone(stack);
 8aa:	00000097          	auipc	ra,0x0
 8ae:	b64080e7          	jalr	-1180(ra) # 40e <clone>
	if(threadid != 0) {
 8b2:	c901                	beqz	a0,8c2 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 8cc:	aa6080e7          	jalr	-1370(ra) # 36e <exit>

00000000000008d0 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 8d4:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 8d6:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x628>
}
 8da:	6422                	ld	s0,8(sp)
 8dc:	0141                	addi	sp,sp,16
 8de:	8082                	ret

00000000000008e0 <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 8e6:	4705                	li	a4,1
 8e8:	87ba                	mv	a5,a4
 8ea:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 8ee:	2781                	sext.w	a5,a5
 8f0:	ffe5                	bnez	a5,8e8 <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 906:	0f50000f          	fence	iorw,ow
 90a:	0805202f          	amoswap.w	zero,zero,(a0)
 90e:	6422                	ld	s0,8(sp)
