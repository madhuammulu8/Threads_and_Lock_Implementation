...
printint(int fd, int xx, int base, int sgn)
{
 ...
 390:	4c450513          	addi	a0,a0,1220 # 850 <digits>
 394:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 45c:	3f8b8b93          	addi	s7,s7,1016 # 850 <digits>
 ...
 59c:	2b090913          	addi	s2,s2,688 # 848 <lock_release+0x1a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 664:	2087b783          	ld	a5,520(a5) # 868 <freep>
 ...
 692:	00e6ea63          	bltu	a3,a4,6a6 <free+0x50>
{
 ...
 6d4:	18f73c23          	sd	a5,408(a4) # 868 <freep>
}
 6d8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 706:	16653503          	ld	a0,358(a0) # 868 <freep>
 ...
 72e:	13e90913          	addi	s2,s2,318 # 868 <freep>
  if(p == (char*)-1)
 732:	5afd                	li	s5,-1
 734:	a88d                	j	7a6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 736:	00000797          	auipc	a5,0x0
 73a:	13a78793          	addi	a5,a5,314 # 870 <base>
 73e:	00000717          	auipc	a4,0x0
 742:	12f73523          	sd	a5,298(a4) # 868 <freep>
 746:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 768:	10a73223          	sd	a0,260(a4) # 868 <freep>
      return (void*)(p + 1);
...
00000000000007c2 <thread_create>:
#include "kernel/stat.h"
#include "user/user.h"
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 7d8:	f0a080e7          	jalr	-246(ra) # 6de <malloc>
	threadid  = clone(stack);
 7dc:	00000097          	auipc	ra,0x0
 7e0:	b64080e7          	jalr	-1180(ra) # 340 <clone>
	if(threadid != 0) {
 7e4:	c901                	beqz	a0,7f4 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 7fe:	aa6080e7          	jalr	-1370(ra) # 2a0 <exit>

0000000000000802 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 806:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 808:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x780>
}
 80c:	6422                	ld	s0,8(sp)
 80e:	0141                	addi	sp,sp,16
 810:	8082                	ret

0000000000000812 <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 818:	4705                	li	a4,1
 81a:	87ba                	mv	a5,a4
 81c:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 820:	2781                	sext.w	a5,a5
 822:	ffe5                	bnez	a5,81a <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 838:	0f50000f          	fence	iorw,ow
 83c:	0805202f          	amoswap.w	zero,zero,(a0)
 840:	6422                	ld	s0,8(sp)
