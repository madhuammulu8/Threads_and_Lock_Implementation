...
main(int argc, char *argv[])
{
  ...
  1a:	94278793          	addi	a5,a5,-1726 # 958 <lock_release+0x48>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8fc50513          	addi	a0,a0,-1796 # 928 <lock_release+0x18>
  ...
  6c:	8d850513          	addi	a0,a0,-1832 # 940 <lock_release+0x30>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	89a50513          	addi	a0,a0,-1894 # 950 <lock_release+0x40>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 472:	50250513          	addi	a0,a0,1282 # 970 <digits>
 476:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53e:	436b8b93          	addi	s7,s7,1078 # 970 <digits>
 ...
 67e:	2ee90913          	addi	s2,s2,750 # 968 <lock_release+0x58>
        while(*s != 0){
...
free(void *ap)
{
 ...
 746:	2467b783          	ld	a5,582(a5) # 988 <freep>
 ...
 774:	00e6ea63          	bltu	a3,a4,788 <free+0x50>
{
 ...
 7b6:	1cf73b23          	sd	a5,470(a4) # 988 <freep>
}
 7ba:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7e8:	1a453503          	ld	a0,420(a0) # 988 <freep>
 ...
 810:	17c90913          	addi	s2,s2,380 # 988 <freep>
  if(p == (char*)-1)
 814:	5afd                	li	s5,-1
 816:	a88d                	j	888 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 818:	00000797          	auipc	a5,0x0
 81c:	17878793          	addi	a5,a5,376 # 990 <base>
 820:	00000717          	auipc	a4,0x0
 824:	16f73423          	sd	a5,360(a4) # 988 <freep>
 828:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 84a:	14a73123          	sd	a0,322(a4) # 988 <freep>
      return (void*)(p + 1);
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 8ba:	f0a080e7          	jalr	-246(ra) # 7c0 <malloc>
	threadid  = clone(stack);
 8be:	00000097          	auipc	ra,0x0
 8c2:	b64080e7          	jalr	-1180(ra) # 422 <clone>
	if(threadid != 0) {
 8c6:	c901                	beqz	a0,8d6 <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
 ...
 8e0:	aa6080e7          	jalr	-1370(ra) # 382 <exit>

00000000000008e4 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 8e8:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 8ea:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x660>
}
 8ee:	6422                	ld	s0,8(sp)
 8f0:	0141                	addi	sp,sp,16
 8f2:	8082                	ret

00000000000008f4 <lock_acquire>:
...
void lock_acquire(lock_t *lock)
{
 ...
 8fa:	4705                	li	a4,1
 8fc:	87ba                	mv	a5,a4
 8fe:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 902:	2781                	sext.w	a5,a5
 904:	ffe5                	bnez	a5,8fc <lock_acquire+0x8>
...
void lock_release(lock_t *lock)
{
 ...
 91a:	0f50000f          	fence	iorw,ow
 91e:	0805202f          	amoswap.w	zero,zero,(a0)
 922:	6422                	ld	s0,8(sp)
