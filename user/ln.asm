...
main(int argc, char *argv[])
{
  ...
  14:	87058593          	addi	a1,a1,-1936 # 880 <lock_release+0x1c>
  18:	4509                	li	a0,2
  ...
  50:	84c58593          	addi	a1,a1,-1972 # 898 <lock_release+0x34>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c6:	4f650513          	addi	a0,a0,1270 # 8b8 <digits>
 3ca:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 492:	42ab8b93          	addi	s7,s7,1066 # 8b8 <digits>
 ...
 5d2:	2e290913          	addi	s2,s2,738 # 8b0 <lock_release+0x4c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 69a:	23a7b783          	ld	a5,570(a5) # 8d0 <freep>
 ...
 6c8:	00e6ea63          	bltu	a3,a4,6dc <free+0x50>
{
 ...
 70a:	1cf73523          	sd	a5,458(a4) # 8d0 <freep>
}
 70e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73c:	19853503          	ld	a0,408(a0) # 8d0 <freep>
 ...
 764:	17090913          	addi	s2,s2,368 # 8d0 <freep>
  if(p == (char*)-1)
 768:	5afd                	li	s5,-1
 76a:	a88d                	j	7dc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 76c:	00000797          	auipc	a5,0x0
 770:	16c78793          	addi	a5,a5,364 # 8d8 <base>
 774:	00000717          	auipc	a4,0x0
 778:	14f73e23          	sd	a5,348(a4) # 8d0 <freep>
 77c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 79e:	12a73b23          	sd	a0,310(a4) # 8d0 <freep>
      return (void*)(p + 1);
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
 ...
 80e:	f0a080e7          	jalr	-246(ra) # 714 <malloc>
	threadid  = clone(stack);
 812:	00000097          	auipc	ra,0x0
 816:	b64080e7          	jalr	-1180(ra) # 376 <clone>
	if(threadid != 0) {
 ...
 834:	aa6080e7          	jalr	-1370(ra) # 2d6 <exit>
...
void lock_init(lock_t *lock)
{
 ...
 83c:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
 83e:	00052023          	sw	zero,0(a0) # 1000 <__BSS_END__+0x718>
}
 842:	6422                	ld	s0,8(sp)
