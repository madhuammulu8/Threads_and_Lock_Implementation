...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	37650513          	addi	a0,a0,886 # 1410 <lock_release+0x1c>
      a2:	00001097          	auipc	ra,0x1
      a6:	e2c080e7          	jalr	-468(ra) # ece <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	36650513          	addi	a0,a0,870 # 1410 <lock_release+0x1c>
      b2:	00001097          	auipc	ra,0x1
      b6:	e24080e7          	jalr	-476(ra) # ed6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	35c50513          	addi	a0,a0,860 # 1418 <lock_release+0x24>
  ...
  chdir("/");
      ...
      da:	36250513          	addi	a0,a0,866 # 1438 <lock_release+0x44>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	36298993          	addi	s3,s3,866 # 1448 <lock_release+0x54>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	35098993          	addi	s3,s3,848 # 1440 <lock_release+0x4c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	62ca0a13          	addi	s4,s4,1580 # 1728 <buf.1239>
     104:	a825                	j	13c <go+0xc4>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     106:	20200593          	li	a1,514
     10a:	00001517          	auipc	a0,0x1
     10e:	34650513          	addi	a0,a0,838 # 1450 <lock_release+0x5c>
    ...
    if(what == 1){
     ...
     2a2:	42a58593          	addi	a1,a1,1066 # 16c8 <lock_release+0x2d4>
     ...
     2c6:	40e50513          	addi	a0,a0,1038 # 16d0 <lock_release+0x2dc>
     ...
     2e4:	18050513          	addi	a0,a0,384 # 1460 <lock_release+0x6c>
     ...
     36c:	11850513          	addi	a0,a0,280 # 1480 <lock_release+0x8c>
     ...
     38e:	10650513          	addi	a0,a0,262 # 1490 <lock_release+0x9c>
     ...
     3c6:	08e50513          	addi	a0,a0,142 # 1450 <lock_release+0x5c>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b04080e7          	jalr	-1276(ra) # ece <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	0d250513          	addi	a0,a0,210 # 14a8 <lock_release+0xb4>
     ...
     430:	0ac50513          	addi	a0,a0,172 # 14d8 <lock_release+0xe4>
     434:	00001097          	auipc	ra,0x1
     438:	a82080e7          	jalr	-1406(ra) # eb6 <unlink>
     43c:	b1dd                	j	122 <go+0xaa>
      unlink("b");
     43e:	00001517          	auipc	a0,0x1
     442:	06250513          	addi	a0,a0,98 # 14a0 <lock_release+0xac>
     446:	00001097          	auipc	ra,0x1
     44a:	a70080e7          	jalr	-1424(ra) # eb6 <unlink>
      link("../grindir/./../a", "../b");
     44e:	00001597          	auipc	a1,0x1
     452:	02a58593          	addi	a1,a1,42 # 1478 <lock_release+0x84>
     456:	00001517          	auipc	a0,0x1
     45a:	08a50513          	addi	a0,a0,138 # 14e0 <lock_release+0xec>
     45e:	00001097          	auipc	ra,0x1
     462:	a68080e7          	jalr	-1432(ra) # ec6 <link>
     466:	b975                	j	122 <go+0xaa>
      unlink("../grindir/../a");
     468:	00001517          	auipc	a0,0x1
     46c:	09050513          	addi	a0,a0,144 # 14f8 <lock_release+0x104>
     470:	00001097          	auipc	ra,0x1
     474:	a46080e7          	jalr	-1466(ra) # eb6 <unlink>
      link(".././b", "/grindir/../a");
     478:	00001597          	auipc	a1,0x1
     47c:	00858593          	addi	a1,a1,8 # 1480 <lock_release+0x8c>
     480:	00001517          	auipc	a0,0x1
     484:	08850513          	addi	a0,a0,136 # 1508 <lock_release+0x114>
     ...
     4b8:	05c50513          	addi	a0,a0,92 # 1510 <lock_release+0x11c>
     ...
     506:	00e50513          	addi	a0,a0,14 # 1510 <lock_release+0x11c>
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1239+0x53>
     ...
     566:	fc650513          	addi	a0,a0,-58 # 1528 <lock_release+0x134>
     ...
     592:	f6250513          	addi	a0,a0,-158 # 14f0 <lock_release+0xfc>
     ...
     5b4:	f6050513          	addi	a0,a0,-160 # 1510 <lock_release+0x11c>
     ...
     5ce:	f6e50513          	addi	a0,a0,-146 # 1538 <lock_release+0x144>
     ...
     61c:	ef850513          	addi	a0,a0,-264 # 1510 <lock_release+0x11c>
     ...
     678:	edc50513          	addi	a0,a0,-292 # 1550 <lock_release+0x15c>
     ...
     6a4:	ec858593          	addi	a1,a1,-312 # 1568 <lock_release+0x174>
     ...
     7a6:	d6e50513          	addi	a0,a0,-658 # 1510 <lock_release+0x11c>
     ...
     7c0:	df450513          	addi	a0,a0,-524 # 15b0 <lock_release+0x1bc>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	6f2080e7          	jalr	1778(ra) # eb6 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	de050513          	addi	a0,a0,-544 # 15b0 <lock_release+0x1bc>
     ...
     7ec:	d8058593          	addi	a1,a1,-640 # 1568 <lock_release+0x174>
     ...
     832:	d8250513          	addi	a0,a0,-638 # 15b0 <lock_release+0x1bc>
     836:	00000097          	auipc	ra,0x0
     83a:	680080e7          	jalr	1664(ra) # eb6 <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	d7850513          	addi	a0,a0,-648 # 15b8 <lock_release+0x1c4>
     ...
     85e:	d7650513          	addi	a0,a0,-650 # 15d0 <lock_release+0x1dc>
     ...
     878:	d7450513          	addi	a0,a0,-652 # 15e8 <lock_release+0x1f4>
     ...
     894:	d7050513          	addi	a0,a0,-656 # 1600 <lock_release+0x20c>
     ...
     8ae:	d7e50513          	addi	a0,a0,-642 # 1628 <lock_release+0x234>
     ...
     8c8:	c8c58593          	addi	a1,a1,-884 # 1550 <lock_release+0x15c>
     8cc:	4509                	li	a0,2
     ...
     8e4:	c7058593          	addi	a1,a1,-912 # 1550 <lock_release+0x15c>
     8e8:	4509                	li	a0,2
     ...
     940:	d1458593          	addi	a1,a1,-748 # 1650 <lock_release+0x25c>
     944:	4509                	li	a0,2
     ...
     9b4:	b6058593          	addi	a1,a1,-1184 # 1510 <lock_release+0x11c>
     9b8:	4509                	li	a0,2
     ...
     a00:	c5458593          	addi	a1,a1,-940 # 1650 <lock_release+0x25c>
     a04:	4509                	li	a0,2
     ...
     a44:	c1058593          	addi	a1,a1,-1008 # 1650 <lock_release+0x25c>
     a48:	4509                	li	a0,2
     ...
     a6c:	c3878793          	addi	a5,a5,-968 # 16a0 <lock_release+0x2ac>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	c2c50513          	addi	a0,a0,-980 # 16a8 <lock_release+0x2b4>
     a84:	00000097          	auipc	ra,0x0
     a88:	41a080e7          	jalr	1050(ra) # e9e <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	c2458593          	addi	a1,a1,-988 # 16b0 <lock_release+0x2bc>
     a94:	4509                	li	a0,2
     ...
     aac:	a6858593          	addi	a1,a1,-1432 # 1510 <lock_release+0x11c>
     ab0:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	a2050513          	addi	a0,a0,-1504 # 14f0 <lock_release+0xfc>
     ad8:	00000097          	auipc	ra,0x0
     adc:	3de080e7          	jalr	990(ra) # eb6 <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	9c050513          	addi	a0,a0,-1600 # 14a0 <lock_release+0xac>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b06:	c0f73b23          	sd	a5,-1002(a4) # 1718 <rand_next>
    go(0);
     b0a:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b18:	9fc50513          	addi	a0,a0,-1540 # 1510 <lock_release+0x11c>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b3e:	6789                	lui	a5,0x2
     b40:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0xe9>
     b44:	00001717          	auipc	a4,0x1
     b48:	bcf73a23          	sd	a5,-1068(a4) # 1718 <rand_next>
    go(1);
     b4c:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b5a:	9ba50513          	addi	a0,a0,-1606 # 1510 <lock_release+0x11c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f56:	7ae50513          	addi	a0,a0,1966 # 1700 <digits>
     f5a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1022:	6e2b8b93          	addi	s7,s7,1762 # 1700 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1162:	59a90913          	addi	s2,s2,1434 # 16f8 <lock_release+0x304>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    122a:	4fa7b783          	ld	a5,1274(a5) # 1720 <freep>
    ...
    1258:	00e6ea63          	bltu	a3,a4,126c <free+0x50>
{
  ...
  freep = p;
    ...
    129a:	48f73523          	sd	a5,1162(a4) # 1720 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12cc:	45853503          	ld	a0,1112(a0) # 1720 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f4:	43090913          	addi	s2,s2,1072 # 1720 <freep>
  if(p == (char*)-1)
    12f8:	5afd                	li	s5,-1
    12fa:	a88d                	j	136c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12fc:	00001797          	auipc	a5,0x1
    1300:	81478793          	addi	a5,a5,-2028 # 1b10 <base>
    1304:	00000717          	auipc	a4,0x0
    1308:	40f73e23          	sd	a5,1052(a4) # 1720 <freep>
    ...
    132e:	3ea73b23          	sd	a0,1014(a4) # 1720 <freep>
      return (void*)(p + 1);
...
int thread_create(void *(*thread_fn)(void*), void *arg) {
    ...
    1390:	e04a                	sd	s2,0(sp)
    1392:	1000                	addi	s0,sp,32
    1394:	84aa                	mv	s1,a0
    1396:	892e                	mv	s2,a1
	int threadid;
	void* stack = (void*)malloc(4096 * sizeof(void));
    1398:	6505                	lui	a0,0x1
    139a:	00000097          	auipc	ra,0x0
    139e:	f0a080e7          	jalr	-246(ra) # 12a4 <malloc>
	threadid  = clone(stack);
    13a2:	00000097          	auipc	ra,0x0
    13a6:	b64080e7          	jalr	-1180(ra) # f06 <clone>
	if(threadid != 0) {
    13aa:	c901                	beqz	a0,13ba <thread_create+0x32>
    else{
    (*thread_fn) (arg);
	exit(0);
    }
    ...
    13b0:	6442                	ld	s0,16(sp)
    13b2:	64a2                	ld	s1,8(sp)
    13b4:	6902                	ld	s2,0(sp)
    ...
    13c4:	aa6080e7          	jalr	-1370(ra) # e66 <exit>

00000000000013c8 <lock_init>:

//Lock implementation
void lock_init(lock_t *lock)
{
    13c8:	1141                	addi	sp,sp,-16
    13ca:	e422                	sd	s0,8(sp)
    13cc:	0800                	addi	s0,sp,16
	lock->unlocked = 0;
    13ce:	00052023          	sw	zero,0(a0) # 1000 <vprintf+0x26>
}
    13d2:	6422                	ld	s0,8(sp)
    13d4:	0141                	addi	sp,sp,16
    13d6:	8082                	ret

00000000000013d8 <lock_acquire>:

void lock_acquire(lock_t *lock)
{
    13d8:	1141                	addi	sp,sp,-16
    13da:	e422                	sd	s0,8(sp)
    13dc:	0800                	addi	s0,sp,16
	while(__sync_lock_test_and_set(&lock->unlocked, 1) != 0);
    13de:	4705                	li	a4,1
    13e0:	87ba                	mv	a5,a4
    13e2:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    13e6:	2781                	sext.w	a5,a5
    13e8:	ffe5                	bnez	a5,13e0 <lock_acquire+0x8>
...
00000000000013f4 <lock_release>:
void lock_release(lock_t *lock)
{
    13f4:	1141                	addi	sp,sp,-16
    13f6:	e422                	sd	s0,8(sp)
  ...
  //   amoswap.w zero, zero, (s1)
    ...
    13fe:	0f50000f          	fence	iorw,ow
    1402:	0805202f          	amoswap.w	zero,zero,(a0)
    1406:	6422                	ld	s0,8(sp)
